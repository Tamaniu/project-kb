# Avid MediaCentral | Cloud UX — Hardware Guide 2023.7
...
- If you plan to install MediaCentral Cloud UX in a virtual environment, see the *Virtualisation Guidelines* documentation on the Avid Knowledge Base.

## Revision History

| Date revised | Changes made |
|---|---|
| 20 September 2023 | Reminder: As of MCCUX v2021.3, SSDs were required for the OS volume for all new installations. SSD storage was encouraged (but not required) for the Data volume. **Announcement:** MCCUX **2023.7 is the last release** to support traditional “spinning disk” HDDs for MCCUX storage. Future releases will support **SSD-only** storage. Organisations still using HDDs should plan a hardware upgrade for future Feature or LTM releases. |
| 27 July 2023 | First publication. |
