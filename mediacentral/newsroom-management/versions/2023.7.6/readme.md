...
Avid MediaCentral | Newsroom Management Avid MediaCentral | Newsroom Management Version 2023.7.6 ReadMe Avid recommends that you read all of the information in this ReadMe thoroughly before installing or using the software described in this document.
...
https://kb.avid.com/articles/en_US/user_guide/MediaCentral-Newsroom-Management Revision History Date Revised Changes Made 3 March 2025 Added fixes related to 2023.7.6 5 December 2024 Added upgrade info and new fixes related to 2023.7.5 11 June 2024 Updated Limitations section for Versions 2023.7.x 30 May 2024 Updated Security Guidelines and added multiple updates, including 7 fixes related to 2023.7.4 14 February 2024 Added 3 fixes related to 2023.7.3 22 January 2024 Added 2 fixes related to 2023.7.2 19 December 2023 Updated to add information related to 2023.7.2 16 October 2023 Updated to add information related to 2023.7.1 2 August 2023 Updated to remove previously documented sections related to releases prior to 2023.7.
27 July 2023 Initial publication: Updated compatibility content, and added some new features and fixed issues for 2023.7 Avid MediaCentral | Newsroom Management Contents New Features in MediaCentral | Newsroom Management 2023.7 10 Fixed in Version 2023.7.6 11 Fixed in Version 2023.7.5 12 Fixed in Version 2023.7.4 12 Fixed in Version 2023.7.3 13 Fixed in Version 2023.7.2 13 Fixed in Version 2023.7.1 13 Fixed in Version 2023.7 14 Limitations and Defects found in Version 2023.7.x 14 Limitations and Defects found in Version 2023.3 14 Limitations and Defects for Earlier Versions 14 Configuring Gmail SMTP Relay Server for Sendmail 17 Updating the iNEWS CTC Service 19 Doc Errata 20 Technical Support Information 20 Security Guidelines Security Guidelines Avid allows you to install an endpoint detection and response solution on your Newsroom Management system. This applies to both single-server and cluster environments. While Avid does not support any specific solution, you can find general guidelines and information related to CrowdStrike Falcon on the following Avid Knowledge Base page: https://kb.avid.com/articles/en_US/troubleshooting/en239659 Compatibility Notes and Issues This section contains compatibility information. Specific versions are mentioned when pertinent.
...
Upgrading to 2023.7.6 This is a client only release. Before upgrading to v2023.7.6 from any version prior to 2023.7.4, you must first complete the installer procedure for upgrading to v2023.7.4 and 2023.7.5, as described in this Readme. Then, do the following procedure to complete the upgrade process:
...
Install and Upgrade Notes and Issues cd /mnt/media sudo bash ./add_this_repo.sh
...
$sudo finit - $sudo dbgen - Downgrade Notes and Issues
...
Fixed in Version 2023.7.6 Feature Description Topline messaging Users at sites employing more generic user IDs can now see real user names in topline supports User Real messaging at the iNEWS Workstation, making for a more user friendly experience.
...
Fixed in Version 2023.7.5 Enhancements The following were improvements in this release made to existing functionality:
...
Fixed in Version 2023.7.3 Fixed in Version 2023.7.3 The following issues have been resolved in MediaCentral | Newsroom Management v2023.7.3.
...
Fixed in Version 2023.7 Bug Number: IN- 179803. In previous versions, users were unable to get read-rate through inewsctc API, if they were not administrator, to re-evaluate the read time of a story when the presenter changed.
...
Limitations and Defects for Earlier Versions Diskcopy reports Critical Error If diskcopy reports messages “diskcopy: 17:09:59 [CRITICAL] first block mirror error: on block 66958 (5:Input/output error)” Users should check the message at the end of the log for actual status. “Successful
...
$sudo sendmailconfig $ systemctl restart sendmail.service Updating the iNEWS CTC Service Updating the iNEWS CTC Service To update inewctc:
