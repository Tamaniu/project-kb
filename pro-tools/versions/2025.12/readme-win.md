...
Avid Pro Tools Software v2025.12 ReadMe for Windows Tools® This ReadMe documents important compatibility information and known issues for all tiers of Pro software, version 2025.12 on Windows 10 (64-bit) and Windows 11.
...
Workaround: When the Send Overlapped Clip to New Playlist preference is enabled, and you move a clip completely over another, the overlapped clip is moved to a new playlist. However, if the track is Undo not in Playlists view, restores the clip on the main playlist, but it does not remove the clip from the alternate playlist. You will have to manually remove that clip from the alternate playlist if you so desire.
...
Errata What's New in Pro Tools 2025.12 Guide and Pro Tools Reference Guide (2025.12) Compensate HW Inputs The What's New in Pro Tools 2025.12 Guide.pdf and the Pro Tools Reference Guide (2025.12) omit the new Compensate HW Inputs option (Setup > Preferences > Mixing).
Enable the Compensate HW Inputs option to automatically compensate for latency with hardware inputs.