...
doc-type: readme
source: pdf
source-file: MCMOSgwy_2024.10.4_ReadMe.pdf
...
# MediaCentral | MOS Gateway — ReadMe v2024.10.4

**Source PDF:** MCMOSgwy_2024.10.4_ReadMe.pdf
**Document revised:** 13/06/2025
**KB article index:** <https://kb.avid.com/articles/en_US/user_guide/MediaCentral-Newsroom-Management>

> This ReadMe covers MOS Gateway versions 2024.10 and 2024.10.4 only.
...
| Date | Changes |
|---|---|
| June 2025 | Added fix updated for 2024.10.4 (5.9) |
...
- **IN-180596:** The installer for MOS Gateway v2024.10 did not properly encode the `mosconfig.xml` and `default-mosconfig.xml` files. This affected only new installations, not upgrades.
