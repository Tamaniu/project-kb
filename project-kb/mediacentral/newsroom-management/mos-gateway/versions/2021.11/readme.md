...
doc-type: readme
source: pdf
source-file: MCMOSGWYv2021.11-ReadMe.pdf
...
# MediaCentral | MOS Gateway — ReadMe v2021.11

**Source PDF:** MCMOSGWYv2021.11-ReadMe.pdf
**Document revised:** 19/11/2021
**Internal version:** v5.4 (from copyright footer: "6 December 2021")
**Online Support:** <http://www.avid.com/onlinesupport>

> This ReadMe is a cumulative document covering MOS Gateway versions 2017.2 through 2021.11.
> For later releases (2022.3 and beyond), refer to the ReadMe documentation for those versions.
...
- For **MediaCentral Subscription Licensing**: requires MediaCentral Licensing Server and Newsroom Management version **2021.11**

> Note: Version 2021.11 is the release that first introduced MediaCentral Subscription Licensing support for MOS Gateway. The wording in this document differs slightly from later ReadMes: it specifies 2021.11 without an "or later" qualifier.
