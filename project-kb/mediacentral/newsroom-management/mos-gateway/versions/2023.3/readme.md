...
doc-type: readme
source: pdf
source-file: MCMOSgwy_2023.3_ReadMe.pdf
...
feature-tags: [readme, compatibility, install, upgrade, new-features, limitations, mos-protocol, vault]
---

# MediaCentral | MOS Gateway — ReadMe v2023.3

**Source PDF:** MCMOSgwy_2023.3_ReadMe.pdf
**Document revised:** 25/03/2023
**KB article index:** <http://avid.force.com/pkb/articles/en_US/user_guide/MediaCentral-Newsroom-Management>

> This ReadMe covers MOS Gateway version 2023.3 only.
> For later releases (2023.7 and beyond), refer to the ReadMe documentation for those versions.
...
| Date | Changes |
|---|---|
| 25 March 2023 | Initial version 2023.3 (5.6) |
