...
doc-type: readme
source: pdf
source-file: MCMOSGWv2022.3.4-ReadMe.pdf
confidentiality: public
date-added: 27/04/2026
last-updated: 27/04/2026
status: superseded
superseded-by: "2023.3"
...
# MediaCentral | MOS Gateway — ReadMe v2022.3.4

**Source PDF:** MCMOSGWv2022.3.4-ReadMe.pdf
**Document revised:** 18/09/2023
**Internal version:** v5.5.1 (from copyright footer: "21 September 2023")
**Online Support:** <http://www.avid.com/onlinesupport>

> This ReadMe is a cumulative document covering MOS Gateway versions 2017.2 through 2022.3.4.
> For later releases (2023.3 and beyond), refer to the ReadMe documentation for those versions.

> **Source anomaly:** Page 8 carries the section heading "Changes for Version 2021.9" but the
> table of contents and revision history both refer to this section as "Changes for Version 2020.9",
> consistent with the revision history entry "Sept 2020 — Added updates for 2020.9 release".
> The heading on page 8 appears to be a typographical error in the published document.
> All content in this file is recorded under the correct version label: 2020.9. ⚠️
...
| Date | Changes |
|---|---|
| 18 Sept 2023 | Added updates for 2022.3.4 release |
...
## Changes for Version 2022.3.4

- **IN-179759:** Previously, the MOSroStorySend service would crash if there was no COM device available to handle a connection from MOS Gateway. This is fixed.
- **IN-179760:** Previously, if COM sessions were not released, the mgwcom service could hang without a COM device to handle a connection from MOS Gateway; this could lead to a MOSroStorySend service failure. This is fixed.
...
> **Source note:** The section heading in the published PDF reads "Changes for Version 2021.9". This is a typographical error; the correct version is 2020.9, as confirmed by the table of contents and the revision history entry dated Sept 2020. ⚠️
...
- Previously, page-number prepend did not work properly when there was a missing page-number in the event form. This is fixed. (IN-128227)
