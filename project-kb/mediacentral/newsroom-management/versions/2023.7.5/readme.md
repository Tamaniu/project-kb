...
Avid MediaCentral | Newsroom Management Avid MediaCentral | Newsroom Management Version 2023.7.5 ReadMe Avid recommends that you read all of the information in this ReadMe thoroughly before installing or using the software described in this document.
...
https://kb.avid.com/articles/en_US/user_guide/MediaCentral-Newsroom-Management Revision History Date Revised Changes Made 5 December 2024 Added upgrade info and new fixes related to 2023.7.5 11 June 2024 Updated Limitations section for Versions 2023.7.x 30 May 2024 Updated Security Guidelines and added multiple updates, including 7 fixes related to 2023.7.4 14 February 2024 Added 3 fixes related to 2023.7.3 22 January 2024 Added 2 fixes related to 2023.7.2 19 December 2023 Updated to add information related to 2023.7.2 16 October 2023 Updated to add information related to 2023.7.1 2 August 2023 Updated to remove previously documented sections related to releases prior to 2023.7.
27 July 2023 Initial publication: Updated compatibility content, and added some new features and fixed issues for 2023.7 Avid MediaCentral | Newsroom Management Contents New Features in MediaCentral | Newsroom Management 2023.7 10 Fixed in Version 2023.7.5 11 Fixed in Version 2023.7.4 11 Fixed in Version 2023.7.3 12 Fixed in Version 2023.7.2 12 Fixed in Version 2023.7.1 13 Fixed in Version 2023.7 13 Limitations and Defects found in Version 2023.7.x 14 Limitations and Defects found in Version 2023.3 14 Limitations and Defects for Earlier Versions 14 Configuring Gmail SMTP Relay Server for Sendmail 17 Updating the iNEWS CTC Service 18 Doc Errata 20 Technical Support Information 20 Security Guidelines Security Guidelines Avid allows you to install an endpoint detection and response solution on your Newsroom Management system. This applies to both single-server and cluster environments. While Avid does not support any specific solution, you can find general guidelines and information related to CrowdStrike Falcon on the following Avid Knowledge Base page: https://kb.avid.com/articles/en_US/troubleshooting/en239659 Compatibility Notes and Issues This section contains compatibility information. Specific versions are mentioned when pertinent.
...
Upgrading to 2023.7.5 Before upgrading to v2023.7.5 from any version prior to 2023.7.4, you must first complete the installer procedure for upgrading to v2023.7.4, as described in this Readme. Then, do both of the following procedures (related to dbrestore and client versioning) to complete the upgrade process:
To update dbrestore:
...
Fixed in Version 2023.7.5 Feature Description Topline messaging Users at sites employing more generic user IDs can now see real user names in topline supports User Real messaging at the iNEWS Workstation, making for a more user friendly experience.
...
Fixed in Version 2023.7.3 Bug Number: IN- 179591. In previous versions, a toolbar button macro for queue path would exhibit unexpected behavior when run for a second time with auto-arrange disabled.
...
Fixed in Version 2023.7.1 Bug Number: IN- 180033. Previously, a story merge error in the inewsctc would cause the inewsctc process to abort.
...
Limitations and Defects found in Version 2023.7.x Limitations and Defects found in Version 2023.7.x The following limitations or defects were discovered in this release of Newsroom Management.
Bug Number: IN- 180261. ∙For 2023.7.x versions, external users could not be used for mgwcom connections, which are used by MOS Gateway Workarounds Either use normal/internal users, or you could make external user work by running the following command at the server: sudo cp /etc/pam.d/rxnet /etc/pam.d/mgwcom At Newsroom Management sites with subscription licensing, users at iNEWS Workstations may experience a short delay at log in while the Newsroom Management system transitions to grace period mode, because the MediaCentral Server goes offline.
...
MCNM-A# ls -l /exc/inewsctc -rwxrwxr-x. 1 so newssys 4559040 July 6 2023 inewsctc MCNM-A# version /exc/inewsctc inewsctc: 2023.7.1 (build 9.1.1.2) RH7 Updating the iNEWS CTC Service If this shows anything earlier than the version prior to the current version to which you are start 601 602 603 updating, abandon the upgrade and start the devices: in this example.
