...
Avid MediaCentral | Newsroom Management Avid MediaCentral | Newsroom Management Version 2023.7.4 ReadMe Avid recommends that you read all of the information in this ReadMe thoroughly before installing or using the software described in this document.
...
https://kb.avid.com/articles/en_US/user_guide/MediaCentral-Newsroom-Management Revision History Date Revised Changes Made 11 June 2024 Updated Limitations section for Versions 2023.7.x; (Rev B. removed iNewsCom info.) 30 May 2024 Updated Security Guidelines and added multiple updates, including 7 fixes related to 2023.7.4 14 February 2024 Added 3 fixes related to 2023.7.3 22 January 2024 Added 2 fixes related to 2023.7.2 19 December 2023 Updated to add information related to 2023.7.2 16 October 2023 Updated to add information related to 2023.7.1 2 August 2023 Updated to remove previously documented sections related to releases prior to 2023.7.
27 July 2023 Initial publication: Updated compatibility content, and added some new features and fixed issues for 2023.7 Avid MediaCentral | Newsroom Management Contents Fixed in Version 2023.7.4 10 Fixed in Version 2023.7.3 11 Fixed in Version 2023.7.2 11 Fixed in Version 2023.7.1 11 Fixed in Version 2023.7 12 Limitations and Defects found in Version 2023.7.x 12 Limitations and Defects found in Version 2023.3 12 Limitations and Defects for Earlier Versions 13 Configuring Gmail SMTP Relay Server for Sendmail 15 Updating the iNEWS CTC Service 17 Doc Errata 18 Technical Support Information 18 Security Guidelines Security Guidelines Avid allows you to install an endpoint detection and response solution on your Newsroom Management system. This applies to both single-server and cluster environments. While Avid does not support any specific solution, you can find general guidelines and information related to CrowdStrike Falcon on the following Avid Knowledge Base page: https://kb.avid.com/articles/en_US/troubleshooting/en239659 Compatibility Notes and Issues This section contains compatibility information. Specific versions are mentioned when pertinent.
...
Upgrading to 2023.7.x Upgrading to 2023.7.x from previous version of 2023.7 or 2023.3 is a standard upgrade without database migration required.
...
Fixed in Version 2023.7.4 Feature Description Topline messaging Users at sites employing more generic user IDs can now see real user names in topline supports User Real messaging at the iNEWS Workstation, making for a more user friendly experience.
...
For 2023.7.x versions up to 2023.7.4, external user could not be used for mgwcom connections,
- which are used by MOS Gateway.
Workarounds Either use normal users or you could make external user work by running the following command at sudo cp /etc/pam.d/rxnet /etc/pam.d/ngwcom.
the server:
- At Newsroom Management sites with subscription licensing, users at iNEWS Workstations may
experience a short delay at log in while the Newsroom Management system transitions to grace period mode, because the MediaCentral Server goes offline.
...
Limitations and Defects for Earlier Versions Limitations and Defects for Earlier Versions This topic provides details on limitations discovered in earlier versions of Newsroom Management (formerly iNEWS), and not addressed in this release. Any available workaround procedures are also documented, when possible.
...
Limitations and Defects for Earlier Versions Macros and Keystrokes Some PCs, when upgraded from older versions of Internet Explorer (such as IE 6, 7 or 8) will experience issues with macros that perform several functions in rapid succession; the macros might not complete all assigned activity in iNEWS. Avid is working with Microsoft on this issue, which is most apparent with macros that trigger the Local Print dialog box or the User Preferences dialog box.
