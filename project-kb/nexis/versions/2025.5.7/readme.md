...
Revision History Date Version Changes March 11, 2026 2025.5.7 Updated the supported CrowdStrike version to 7.32.
February 26, 2026 2025.5.7 Added a note clarifying that the features and fixes introduced in Avid NEXIS 2025.10.0 are not included in the 2025.5.6 and 2025.5.7 releases.
...
November 3, 2025 2025.10.0 Updated the supported CrowdStrike version to 7.24.
2025.5.1 Updated the Limited Availability and Upgrade notice in Avid NEXIS 2025.5.1.
Date Version Changes August 4, 2025 2025.5.1 Added SSENG-44465 to the known issues.
July 31, 2025 2025.5.1 Added full support for macOS 15 Sequoia.
July 9, 2025 2025.5.1 See "What’s New in Avid NEXIS 2025.5.1" on page 10 June 4, 2025 2025.5.0 Withdrawn due to a write failure issue on Avid NEXIS | F5 systems configured with mirrored workspaces and link aggregation (LACP).
See "What’s New in Avid NEXIS 2025.5.0" on page 11 June 2, 2025 2025.2.2 Removed SSENG-42854, SSENG-43568, and SSENG-43596 from the Server Fixes section and moved them to the Known Issues section.
April 22, 2025 2025.2.2 See "What’s New in Avid NEXIS 2025.2.2" on page 13 April 7, 2025 2025.3.0 Added support for built-in 10GbE network adapters for macOS Sequoia clients.
March 25, 2025 2025.3.0 See "What’s New in Avid NEXIS 2025.3.0" on page 13 February 25, 2025 2025.2.0 Withdrawn due to an issue that may prohibit write operations. Fixed in Avid NEXIS | VFS 2025.2.2.
Contents What’s New in Avid NEXIS 2025.5.1 10 What’s New in Avid NEXIS 2025.5.0 11 What’s New in Avid NEXIS 2025.2.2 13 What’s New in Avid NEXIS 2025.3.0 13 What’s New in Avid NEXIS 2025.2.0 14 USM Versions 16 Hardware and Software Requirements 18 Supported Upgrade Paths 18 System Director and Client Version Compatibility 19 Compatibility with Other Avid Products 21 Third Party Editor Compatibility 21 System Configuration Limits 22 On-Premises System Performance 24 Cloud System Performance 28 Known Issues 31 Special Notes 37 Accessing the Online Documentation The Avid online documentation contains all the product documentation in PDF format. You can access the documentation from the Knowledge Base site specific to your release. Download and install Acrobat Reader before you access the PDF documentation.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Server and 2025.5.7 Recommended for on-premises Avid NEXIS systems only.
Clients Resolves an issue in Avid NEXIS 2025.5.5 where an assertion in the Storage Manager leads to Media Pack disconnections.
Clients only 2025.5.6 Required for Media Composer 2025.12.0.
Server and 2025.5.5 Includes major bug fixes.
Clients Clients (On- 2025.10.0 Support for Ubuntu 24.04 for on-premises clients; Support for Rocky premises) Linux clients in Avid NEXIS | Cloud Storage (Azure Nearline and Online); Avid NEXIS | Remote; Avid NEXIS Management API Documentation.
Server and Recommended for Avid NEXIS | Cloud Storage systems.
Clients (Cloud) Server and 2025.5.3 Bug fixes. Fixed the performance regression issue found in Avid NEXIS | Clients VFS 2025.5.1.
Server and 2025.5.1 Availability is limited due to a performance regression issue.
Clients Includes all features and fixes from 2025.5.0; Full support for macOS 15 Sequoia; Resolved the write failure issue found in the previous release.
Server and 2025.5.0 Withdrawn due to a write failure issue on Avid NEXIS | F5 systems Clients configured with mirrored workspaces and link aggregation (LACP).
Support for 1.6TB SSD as a system drive; Support for Windows 11 build 24H2 and Amazon Linux 2023; Monitoring and reporting Controller memory errors; AWS updates.
Server and 2025.2.2 Includes all features and fixes from 2025.2.0, along with additional bug Clients fixes.
> **Note:** SupportformacOS15Sequoiaisnotincludedintheclientinstaller
forthisrelease.FormacOSSequoiaclients,useAvidNEXISClient v2025.3.0orhigher.
macOS 2025.3.0 Minimum recommended version for macOS Sequoia clients.
Clients only What’s New in Avid NEXIS 2025.5.7 Product Version Guidance Support for macOS 15 Sequoia on Avid NEXIS clients (On-premises only).
Server and 2025.2.0 Withdrawn due to an issue that may prohibit write operations. Fixed in Clients Avid NEXIS | VFS 2025.2.2.
...
This version is recommended for use with Avid Pro Tools. See "Compatibility with Other Avid Products" on page 21 Server and 2024.6.2 Resolved a continuous reboot issue and the installation dependencies in Clients the previous release.
Server and 2024.6.0 Matches release version with Avid editing and media management Clients products. Fix for Avid NEXIS | E5 NL Engines using LACP.
...
> **Note:** FeaturesandfixesintroducedinAvidNEXIS2025.10.0arenotincludedinthisrelease.
Avid NEXIS version 2025.5.7 is a patch release for on-premises systems only. It includes the following fixes:
Server Fixes SSENG-46549, SSENG-46595, SSENG-46563, SSENG-46675: In Avid NEXIS 2025.5.5, an assertion
- may occur due to a timing issue in the Avid NEXIS control plane connection and disconnection logic.
This causes the Storage Manager to hang on shutdown. A deadlock during the shutdown process What’s New in Avid NEXIS 2025.5.6 prevents the Storage Manager from restarting, resulting in Media Pack disconnections.
SSENG-46654: In Avid NEXIS 2025.5.5, a scheduling issue in the Storage Manager read workflow
- causes slow export operations in Media Composer.
What’s New in Avid NEXIS 2025.5.6
> **Note:** FeaturesandfixesintroducedinAvidNEXIS2025.10.0arenotincludedinthisrelease.
Avid NEXIS version 2025.5.6 is a client-only patch release that includes the following:
Client Fixes
- SSENG-45048: The AvidSharedStorageAccess.dylib exports BOOST symbols, which causes Media
Composer to crash on Intel-based Macs or on Apple Silicon Macs running through Rosetta.
What’s New in Avid NEXIS 2025.5.5
> **Note:** FeaturesandfixesintroducedinAvidNEXISversion2025.10.0arenotincludedinthisrelease.
Avid NEXIS version 2025.5.5 is a patch release for on-premises systems only. It includes the following fixes:
Server Fixes (in Numerical Order) SSENG-44038: After upgrading to Avid NEXIS 2025.2.2, the Storage Group and Workspace
- capacities are displayed incorrectly in the Avid NEXIS Management Console.
- SSENG-44238: The Documentation link in the Avid NEXIS Management Console is broken,
displaying the error "URL No Longer Exists".
- SSENG-44323, SSENG-44348, SSENG-45065: Starting with Avid NEXIS 2024.10.0, an Index Server:
Segmentation fault error may occur, causing the System Director to restart. This issue happens when the File Delete Logging feature is enabled and a deletion is suddenly interrupted.
SSENG-44652, SSENG-44832, SSENG-44860, SSENG-44981, SSENG-44118, SSENG-45058:
- Increasing client write bandwidth on mirrored Avid NEXIS systems breaks Media Pack connections,
resulting in delayed write failures.
- SSENG-44909: In the Connection status page of the Avid NEXIS Management Console, all fields
may appear blank when the system has only one active connection.
SSENG-44947, SSENG-44948, SSENG-44952: In Avid NEXIS 2025.5.3, a certificate initialization
- issue may occur, showing Error: 502 when accessing the Avid NEXIS Management Console.
Limitations and Defects Found See the "Known Issues" on page 31 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
Windows 10 No Longer Supported Windows 10 is no longer supported in this release. See the "Supported Client Operating Systems" on page 20.
What’s New in Avid NEXIS 2025.10.0 Avid NEXIS version 2025.10.0 is a client-only release for on-premises systems and a full cloud kit release.
This release includes the following:
What’s New in Avid NEXIS 2025.10.0 Support for Ubuntu 24.04 for on-premises Avid NEXIS Clients
...
This release adds support for Ubuntu 24.04 as a client operating system for on-premises Avid NEXIS systems with 1GbE, 10GbE, and 40GbE network connections. See "Supported Client Operating Systems" on page 20. For installation and configuration instructions, see the AvidNEXISClientManagerInstallation andUser'sGuideavailable in the Avid NEXIS Documentation Knowledge Base.
> **Note:** TheUbuntukitdoesnotsupporttheClientManagerGUI.
Support for Rocky Linux Clients in Avid NEXIS | Cloud Storage (Azure Nearline and Online) Rocky Linux is now a supported client operating system for Avid NEXIS | Cloud Storage (Azure Nearline and Online). See "Supported Client Operating Systems" on page 20. For installation instructions, refer to the AvidNEXIS®ClientManagerInstallationandUser’sGuideavailable in the Avid NEXIS Documentation Knowledge Base.
Avid NEXIS | Remote This release introduces Avid NEXIS | Remote in Avid NEXIS | Cloud Storage (Azure Online, AWS Nearline S3 Standard, and AWS Online S3 Express One Zone) workflows, with the relevant license entitlement applied on the system. Avid NEXIS | Remote leverages caching and accelerated transfers to pre-read media in advance, helping overcome performance issues caused by network limitations, latency, or variations in cloud storage performance.
Using the Avid NEXIS Client Manager, you can enable caching of media files to optimize performance for Avid Media Composer and Adobe Premiere Pro. For more information, refer to the "Using Avid NEXIS | Remote" chapter in the AvidNEXISClientManagerInstallationandUser’sGuide, available in the Avid NEXIS Documentation Knowledge Base.
Avid NEXIS Management API Documentation The Avid NEXIS Management API Documentation is now available in the Help menu of the Avid NEXIS Management Console (Cloud only).
...
What’s New in Avid NEXIS 2025.5.3 Removal of CentOS Installers The Avid NEXIS | VFS Gateway and Avid NEXIS Client installers for CentOS have been removed from both the installer kit and the Installers page in the Management Console.
...
Windows 10 End of Support Avid NEXIS 2025.10.0 is the last Avid NEXIS version tested and qualified for use with Windows 10. Microsoft officially ended support for Windows 10 on October 14, 2025. For more information about Avid product and software support for Windows 10, please visit this article: https://kb.avid.com/pkb/articles/en_ US/Knowledge/Windows-10-End-of-Support.
Client Fixes
- SSENG-44092: On Windows 11 24H2 machines with Avid NEXIS Client version 2025.5.x, a dialog
box appears with the following message: "Program Compatibility Assistant: This module is blocked from loading into the Local Security Authority. \Device\HarddiskVolume5\Windows\System32\ AvidFosNP.dll" Limitations and Defects Found See the "Known Issues" on page 31 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
What’s New in Avid NEXIS 2025.5.3 Avid NEXIS version 2025.5.3 is a patch release that includes the following fixes:
Server Fixes (in Numerical Order) SSENG-44465: In Avid NEXIS 2025.5.1, media mirror writes fail when an Avid NEXIS | F2 Storage
- engine (F2/F2X) is configured with LACP (Link Aggregation Control Protocol) and auto-negotiated
25Gbps network links.
- SSENG-44552: In Avid NEXIS | Cloud Storage (AWS Online EBS) version 2025.5.1 or earlier, adding
media packs to an existing Storage Group created via public API fails with the error message:
"Failed: Unable to complete operation. Invalid parameter".
This issue is fixed in version 2025.5.3, but the fix only applies to newly created Storage Groups.
Storage Groups created in 2025.5.1 or earlier remain affected and must be deleted and recreated in 2025.5.3 to avoid this error.
- SSENG-44695: When smaller-sized Media Packs are added to an existing storage group, and the
new Effective capacity is less than the total capacity already allocated to workspaces, the system triggers an assert error. With this fix, the system will instead return a "Failed: Reservation exceeds Storage Group capacity" error.
Client Fixes
- SSENG-44473, SSENG-44492: The avidfos service crashes on Avid NEXIS clients. This issue is
caused by multiple threads rapidly opening and closing directories, a pattern often triggered by third-party file transfer applications.
What’s New in Avid NEXIS 2025.5.1 Windows 10 End of Support Avid will no longer support Windows 10 after Microsoft's end-of-support date on October 14, 2025. Since Microsoft will stop providing security updates, Avid recommends that you upgrade to Windows 11 to ensure continued support and security.
...
Support for macOS 15 Sequoia Clients with 10GbE, 25GbE, and Higher Network Adapters Avid now fully supports macOS 15 Sequoia clients using 10GbE, 2x10GbE, 25GbE, 40GbE, and 100GbE external network adapters on Macs with Apple Silicon (M-series) or Intel chips. See "Supported Client Operating Systems" on page 20
...
For clients using Sonnet Twin10G SFP+ adapters, do not load the Sonnet kext driver package. Use the built-in Apple dext driver instead. For more details, see "Known Issues" on page 31.
...
What’s New in Avid NEXIS 2025.5.0 SSENG-44095: After upgrading to Avid NEXIS | VFS 2025.5.0, an issue with aggregated link speed
...
Previous Avid NEXIS | VFS releases— v2025.2.2 and earlier, are not compatible with the new 1.6TB SSD. Replacing a failed system drive with the new 1.6TB SSD without first updating to Avid NEXIS | VFS 2025.5.0 or later will result in no metadata redundancy and could lead to data loss.
...
Support for Windows 11 build 24H2 In this release, Avid adds support for Windows 11 build 24H2 with 1GbE, 2x1GbE, 10GbE, 2x10GbE, and 40GbE network adapters. See "Supported Client Operating Systems" on page 20 What’s New in Avid NEXIS 2025.5.0 Monitoring and Reporting Memory Errors Avid NEXIS 2025.5.0 introduces a monitoring and notification feature that detects and reports memory errors in the Controllers and notifies the customers in the Management Console and via email (if enabled).
...
Client Fixes
- SSENG-40594, SSENG-40601: CrowdStrike causes delay issues with Avid NEXIS clients, resulting in
...
- or when launching the Client Manager. This issue only occurs on macOS clients that have multiple
active network interfaces and happens when a network interface is removed. This may affect What’s New in Avid NEXIS 2025.2.2 clients connecting to Avid NEXIS cloud systems.
...
Client Fixes SSENG-38029: After upgrading the Avid NEXIS Client to 2023.8.0, project sharing in Edius fails.
...
Support for macOS 15 Sequoia Clients with 1GbE and built-in 10GbE Network Adapters or 2 x 1GbE, and built-in 1 or 2 x 10GbE network adapters on Apple Silicon (M1, M2, M3, M4) and Intel- based Mac computers. See "Supported Client Operating Systems" on page 20 for more information.
What’s New in Avid NEXIS 2025.2.0 Limitations and Defects Found See the "Known Issues" on page 31 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
...
Support for Shared Delete Avid NEXIS 2025.2.0 adds support for Shared Delete, allowing a file to be deleted, renamed, or moved by one application even if another application is using it.
...
Support for Rocky Linux with 40GbE Connection This release adds support for on-premises Rocky Linux clients with 40GbE network adapters; see "Supported Client Operating Systems" on page 20 for more information.
What’s New in Avid NEXIS 2025.2.0 Removal of the Avid NEXIS Client Installer for CentOS from the Cloud Starting with Avid NEXIS 2025.2.0, the Avid NEXIS Client installer for CentOS has been removed from cloud platforms.
...
USM Versions SSENG-39420: If no 10GB cable is connected to the Controller, the Management Console displays
...
Supported Upgrade Paths You can upgrade any Avid NEXIS system according to the upgrade path described next. For instructions on how to upgrade an Engine or System Director Appliance, see the AvidNEXISSetupandMaintenance Guide, or the AvidNEXISAdministrationGuide.
All Avid NEXIS systems can upgrade to the following versions.
Platforms Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2025.5.7 2020.x, 2021.x, 2022.x, 2023.x, 2024.2.x, 2024.5.0, Do not upgrade any on-premises system to 2024.6.x, 2024.10.0, 2023.7.0, 2025.2.0, or 2025.5.0.
2024.11.0, 2025.2.2, 2025.5.1 (LA), 2025.5.3, Delete all media from Avid NEXIS | 2025.5.5 Cloudspaces while your subscription is still active before upgrading to 2023.8.0 or higher.
Avid NEXIS | Cloud 2021.3.1 and newer 2025.10.0 Storage systems To upgrade Avid NEXIS | Cloud c Do not upgrade any Avid NEXIS Cloud Storage 2020.7.x and earlier Storage system to 2023.7.0, 2023.8.0, or to Avid NEXIS | FS version 2025.2.0.
2021.x, please contact Avid Customer Service or your sales System Director and Client Version Compatibility Platforms Current Avid NEXIS Version Can Upgrade Directly To representative to assist with c Avid NEXIS | Cloud Storage systems on AWS the upgrade.
running version 2025.2.x and earlier cannot be upgraded to 2025.5.0 or higher.
...
Avid NEXIS Server and Client Compatibility Avid NEXIS Avid NEXIS Avid NEXIS Avid NEXIS Avid NEXIS Avid NEXIS 2022.x Client 2023.3 Client 2023.8 Client 2023.12 Client 2024.x Client2025.x Client Avid NEXIS 2022 N N N N server Avid NEXIS 2023.3 N N N N server Not Not Avid NEXIS 2023.8 recommended recommended N N N N server for new for new Avid NEXIS 2023.12 installations or installations or Y Y Y server Not upgrades upgrades Avid NEXIS 2024.x recommended for Y Y Y server new installations Avid NEXIS 2025.x or upgrades Y Y Y server Recommended Supported but not recommended for new systems Not supported. Upgrade core (server) to Avid NEXIS 2023.12 or newer ASAP Recommended Version Avid NEXIS 2023.12 is the minimum recommended version that prevents media consistency errors. Newer versions include additional features and fixes. Avid recommends running the latest version of server and client due to the enhanced functionality, security enhancements, and fixes. For a complete list of features and fixes, see the "What's New" section of this ReadMe.
> **Note:** UpgradeAvidNEXISservertoversion2023.12orhigherbeforeupgradingclients.
System Director and Client Version Compatibility Avid NEXIS | VFS 2025.5.0, 2025.2.0 and 2023.7.0 were withdrawn and not recommended for any system.
...
Operating Supported Versions Notes System macOS 15.7.1 (Sequoia) or later, on Apple Silicon n macOSclientsarenotsupportedon (M1, M2, M3, M4) and Intel-based Mac AvidNEXIS|CloudStorage(Azure computers with all supported NICs.
NearlineandOnline).
14.x (Sonoma) with latest updates 13.x (Ventura) with latest updates CentOS 7.9 General Avid NEXIS Client use
> **Note:** AvidwillendsupportforCentOS
clientsinafuturerelease.
Rocky Linux v9.4 kernel 5.14.0-427.13.1 with 1GbE, Supported on on-premises Avid NEXIS 10GbE, and 40GbE NICs clients and Avid NEXIS | Cloud Storage (Azure Nearline and Online) clients.
Compatible with AutoDesk Flame 2025 Ubuntu 24.04 with 1GbE, 10GbE, and 40GbE NICs Ubuntu 24.04 is supported only on on- premises Avid NEXIS clients starting with 22.04 Avid NEXIS 2025.10.0.
To migrate MediaCentral | Cloud UX systems from CentOS to Ubuntu, see the MediaCentral Cloud UX Documentation.
See "Ubuntu Client and MediaCentral Cloud UX Compatibility" on the next page Amazon Linux Amazon Linux 2023 Supported only on Avid NEXIS | Cloud Storage systems on AWS.
Windows 11 build 24H2 See "Windows Issues" on page 35.
11 build 23H2 Windows Server 2022 with latest Service Pack Compatibility with Other Avid Products Operating Supported Versions Notes System 2019 with latest Service Pack Ubuntu Client and MediaCentral Cloud UX Compatibility Avid NEXIS version 2023.3.0 was the first release to support Ubuntu for clients, intended to accommodate the move of MediaCentral | Cloud UX from CentOS to Ubuntu Linux. Performance was limited to 1Gb/s regardless of the physical connection, which was consistent with previous versions but slower than optimal.
...
System Configuration Limits Autodesk Flame®
...
- Maxon Cinema 4D®
System Configuration Limits The following tables list the configuration limits for on-premises and Avid NEXIS | Cloud Storage systems in the current release.
On-Premises Limits Item Embedded System Director System Director Appliance Media Packs (per 4, in any combination of Scale-Out and 8 in a High Performance Storage Group system) High Performance 24 total (optionally including up to 8 in a High Performance Storage Group) with the Avid NEXIS | VFS Standard or Avid NEXIS | FS Standard license and any combination of Avid NEXIS Engines 64 total (optionally including up to 8 in a High Performance Storage Group) with the Avid NEXIS | VFS Advanced or Avid NEXIS | FS Advanced license, and any combination of Avid NEXIS Engines Media Packs (per 1 in all 2U chassis (Avid NEXIS | E2, Avid NEXIS | E2 All-Mirror, Avid NEXIS | E2 SSD, Avid Engine) NEXIS | PRO, Avid NEXIS | F2, Avid NEXIS | F2X, Avid NEXIS | PRO+) 1-2 in Avid NEXIS | F2 SSD 1–2 in all 4U chassis (Avid NEXIS | E4, Avid NEXIS | E4 All-Mirror) 4–8 in all 5U chassis (Avid NEXIS | E5, Avid NEXIS | E5 NL, Avid NEXIS | E5 All-Mirror, Avid NEXIS | F5, Avid NEXIS | F5 NL) Storage Groups 4, optionally including one High 32, optionally including one High Performance Storage Group Performance Storage Group Workspaces 1024 (including Workspaces for Teams) 3072 (including Workspaces for Teams) Teams 19 80 Team Quotas Up to 255 Team Quotas per system (Teams have only one quotaperStorage Group — which can be increased or decreased — but can have a quota in multiple Storage Groups) Team Admin Users No enforced limit System Configuration Limits Item Embedded System Director System Director Appliance Users (Clients) 5640 (including Users in Teams) User Groups 1028 (including User Groups in Teams) Group Non-Team users can belong to 71 non-Team user groups Memberships per Team users can belong to 71 user groupsinthesameTeam User Connected 40 with Avid NEXIS E-Series/F-Series 165 with Avid NEXIS | VFS Standard or Avid (Active) Clients Engines NEXIS | FS Standard license 30 with Avid NEXIS | PRO or Avid NEXIS | 330 with Avid NEXIS | VFS Advanced or PRO+ Avid NEXIS | FS Advanced license Up to 10 to a High Performance Storage Group (Avid strongly recommends no more than 10) Files and Folders 8 million in Avid NEXIS E-series/F-Series 175 million in configurations with an Avid configurations NEXIS | SDA+ and the Avid NEXIS | FS Advanced license running Avid NEXIS 5 million in configurations where the version 2023.8.0 or higher System Director service runs on an Avid NEXIS | PRO+ 28.4 million in configurations with an Avid NEXIS | SDA or Avid NEXIS | SDA+ with the 3 million in configurations where the Avid NEXIS | FS Standard license.
...
(Workspace name + path + file name) Windows: 32KiB
- macOS: 32KiB
- Ubuntu: 4KiB
...
> **Note:** Unicodecharacterscanbemulti-byte.
On-Premises System Performance This section describes the bandwidth for the different Media Pack bind options, and the aggregate throughput for Storage Groups using those Media Packs.
...
Bind Option Bandwidth Rating (Nominal) Supported On Scale Out 480MB/sec Avid NEXIS | PRO+ Avid NEXIS | F2, Avid NEXIS | F2X, Avid NEXIS | F5 High Performance 700MB/sec Avid NEXIS | PRO+ On-Premises System Performance Bind Option Bandwidth Rating (Nominal) Supported On Avid NEXIS | F2, Avid NEXIS | F2X SSD, 1 Media Pack All Reads: 4GB/sec Avid NEXIS | F2 SSD only All Writes: 2GB/sec GB/sec Write SSD, 2 Media All Reads: 8GB/sec Packs All Writes: 4GB/sec 50/50 reads/writes: 4GB/sec Read, 2GB/sec Write Aggregate Bandwidth by Media Pack Protection Type The actual write bandwidth depends on protection type. Aggregate bandwidth is therefore a function of protection type and the proportion of reads to writes in the workflow.
...
Media Pack Protection MP Protection and Engine Protection Read% Write% None One Two One Disk + Two Disk + Disk Disk Mirroring Mirroring 100 0 480 MB/sec 480 480 480 480 90 10 480 474 468 427 417 80 20 480 468 457 384 369 70 30 480 463 447 349 331 60 40 480 457 436 320 300 On-Premises System Performance Media Pack Protection MP Protection and Engine Protection Read% Write% None One Two One Disk + Two Disk + Disk Disk Mirroring Mirroring 50 50 480 452 427 295 274 40 60 480 447 417 274 253 30 70 480 441 409 256 234 20 80 480 436 400 240 218 10 90 480 431 392 226 204 0 100 480 427 384 213 192 Usable Storage 100% 89% 80% 44% 40% High Performance The High Performance data in the following table is applicable to these models:
Avid NEXIS | PRO+
- Avid NEXIS | F2 and Avid NEXIS | F2X
Media Mirroring is not supported with High Performance Storage Groups.
Media Pack Protection Read% Write% None One Disk Two Disk 100 0 700 MB/sec 700 700 90 10 700 691 683 80 20 700 683 667 70 30 700 675 651 60 40 700 667 636 50 50 700 659 622 40 60 700 651 609 30 70 700 644 596 20 80 700 636 583 10 90 700 629 571 0 100 700 622 560 Usable Storage 100% 89% 80% SSD Performance SSD Performance is the only bind option available on Avid NEXIS | F2 SSD Engines.
On-Premises System Performance Media Pack Protection Read% Write% One Disk Two Disk 100 0 4000 4000 90 10 3704 3636 80 20 3448 3333 70 30 3226 3077 60 40 3030 2857 50 50 2857 2667 40 60 2703 2500 30 70 2564 2353 20 80 2439 2222 10 90 2326 2105 0 100 2222 2000 Usable Storage 89% 80% Drive Rebuilds and System Performance When a drive in a Media Pack fails, the data from that drive is rebuilt from the other drives in that Media Pack, and involves only those drives. During a rebuild, the Media Pack’s performance rating drops by the rating of one drive (10%). With no I/O on the system, the fastest a drive can be rebuilt is also equal to the rating of one drive.
...
Cloud System Performance This section describes the bandwidth and performance data for the various virtual machine (VM) types, operating systems, and codecs used with Avid NEXIS | Cloud Storage.
...
- Avid NEXIS | Cloud Nearline Storage is suited for offline editing and push-and-pull workflows that
require quick retrieval.
- Avid NEXIS | Cloud Online Storage is ideal for online editing requiring high-availability and low
latency for realtime workflows.
Workflow Types and Virtual Machine Sizes Virtual Machines come in different types and sizes to accommodate various editing workflows. The following table outlines the differences between Small, Medium, Large, and Extra Large workflow types, along with the corresponding VM configurations for each.
Workflow Type Workflow Description Small (S) Lightweight HD television (news, programming) workflow based on low bandwidth codecs.
...
Recommended Virtual Machine Configuration for Different Editing Workflows Size Azure AWS S Standard D8s/D8ds g4dn.2xlarge (v3, v4 or v5) (8 core, 32 RAM) (8 core, 32 RAM) M Standard D16s/D16ds g4dn.4xlarge (v3, v4 or v5) (16 core, 64 RAM) (16 core, 64 RAM) L Standard D32s/D32ds g4dn.8xlarge (v3, v4 or v5) (32 core, 128 RAM) Cloud System Performance Size Azure AWS (32 core, 128 RAM) XL Standard D64s/D64ds g4dn.16xlarge (v3, v4 or v5) (64 core, 256 RAM) (64 core, 256 RAM)
> **Note:** AvidrecommendsusingLarge-sizeVMswhenusingMediaComposer.However,dependingonthe
complexityoftheproject,alargerVMsizemightberequired.
Approximate Bandwidth The following table provides the estimated read and write performance on Linux, Windows, and macOS.
> **Note:** Theresultswereobtainedinacontrolledlabenvironment.Actualperformancemayvary.Aswithall
Cloud-basedworkflows,performancedependsonregionalvariancesandworkloadsnotcontrolled byAvid.
Avid NEXIS | Cloud Nearline Storage Operating System Read Bandwidth (MB/s) Write Bandwidth (MB/s) Azure AWS Azure AWS Linux - 80 - 100 Windows 350 80 250 100 macOS n/a 80 n/a 100 Avid NEXIS | Cloud Online Storage Operating System Read Bandwidth (MB/s) Write Bandwidth (MB/s) Azure AWS Azure AWS Linux 650 2250 850 1250 Windows 900 1100 900 1750 macOS n/a 1100 n/a 950 Playback Performance This section presents the playback performance in Media Composer, comparing different codecs— both native and foreign compression, and the number of streams supported across various VM sizes.
AWS Playback Performance Codec Stream Count per VM Size S M L XL HD Cloud System Performance Codec Stream Count per VM Size S M L XL UHD Foreign Compression Known Issues Known Issues The following are known issues with Avid NEXIS software or third-party vendors. When a workaround exists, it appears in the paragraph directly following the issue description.
Avid NEXIS On-Premises Systems Issues SSENG-44837: A Media Pack that is not visible in the system may appear in the SDA logs. This does not affect system functionality and can be ignored.
...
Known Issues Workaround: Turn all of the power supplies off, then back on, on each Engine after updating the enclosure ID.
...
Known Issues (None): The Avid NEXIS Log Utility may occasionally fail to generate logs with the error message “Couldn’t find OAM logs”.
...
Avid NEXIS Cloud Storage Issues SSENG-24571: Due to limitations in the Avid NEXIS Cloud file system, potential data consistency issues may occur in certain scenarios involving internet connection interruptions.
...
Avid NEXIS | Remote Issues SSENG-44449: In Adobe Premiere Pro, an error dialog in the Avid NEXIS Remote Panel may remain open even after clicking OK.
...
Known Issues Mac Platforms and macOS Issues SSENG-44726: Starting with macOS 15.3 Sequoia, systems with the firewall enabled experienced read and write errors due to socket send failures.
...
Windows Issues
> **Note:** MicrosoftendedsupportforWindows10onOctober14,2025.
