...
November 3, 2025 2025.5.3 Updated the supported CrowdStrike version to 7.24.
2025.5.1 Updated the Limited Availability and Upgrade notice in Avid NEXIS 2025.5.1.
August 4, 2025 2025.5.1 Added SSENG-44465 to the "Known Issues" on page 26 July 31, 2025 2025.5.1 Added full support for macOS 15 Sequoia.
...
April 22, 2025 2025.2.2 See "What’s New in Avid NEXIS 2025.2.2" on page 10 April 7, 2025 2025.3.0 Added support for built-in 10GbE network adapters for macOS Sequoia clients.
March 25, 2025 2025.3.0 See "What’s New in Avid NEXIS 2025.3.0" on page 10 February 25, 2025 2025.2.0 Withdrawn due to an issue that may prohibit write operations. Fixed in Avid NEXIS | VFS 2025.2.2.
Contents What’s New in Avid NEXIS 2025.2.2 10 What’s New in Avid NEXIS 2025.3.0 10 What’s New in Avid NEXIS 2025.2.0 11 USM Versions 13 Hardware and Software Requirements 15 Supported Upgrade Paths 15 System Director and Client Version Compatibility 16 Compatibility with Other Avid Products 19 Third Party Editor Compatibility 19 System Configuration Limits 19 System Performance (On-Premises) 22 Known Issues 26 Special Notes 32 Accessing the Online Documentation The Avid online documentation contains all the product documentation in PDF format. You can access the documentation from the Knowledge Base site specific to your release. Download and install Acrobat Reader before you access the PDF documentation.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Server and 2025.5.3 Recommended version for all Avid NEXIS systems (On-premises and Cloud).
Clients Bug fixes. Fixed the performance regression issue found in Avid NEXIS | VFS 2025.5.1.
...
Server and 2024.10.0 Support for Windows 11 build 23H2; File delete logging; Bug fixes and What’s New in Avid NEXIS 2025.5.3 Product Version Guidance Clients improvements.
This version is recommended for use with Avid Pro Tools. See "Compatibility with Other Avid Products" on page 19 Server and 2024.6.2 Resolved a continuous reboot issue and the installation dependencies in the Clients previous release.
...
- SSENG-44552: In Avid NEXIS | Cloud Online Storage (AWS EBS) version 2025.5.1 or earlier, adding
...
What’s New in Avid NEXIS 2025.5.1 Client Fixes SSENG-44473: The avidfos service crashes on Avid NEXIS clients. This issue is caused by multiple
- threads rapidly opening and closing directories, a pattern often triggered by third-party file
...
The 2x100GbEController can be mixed with a 2x50GbE Controller within a single chassis.
Support for macOS 15 Sequoia Clients with 10GbE, 25GbE, and Higher Network Adapters Avid now fully supports macOS 15 Sequoia clients using 10GbE, 2x10GbE, 25GbE, 40GbE, and 100GbE external network adapters on Macs with Apple Silicon (M-series) or Intel chips. See "Supported Client Operating Systems" on page 17
...
For clients using Sonnet Twin10G SFP+ adapters, do not load the Sonnet kext driver package. Use the built-in Apple dext driver instead. For more details, see "Known Issues" on page 26.
What’s New in Avid NEXIS 2025.5.0 Server Fixes SSENG-42854, SSENG-43568, SSENG-43569: Some systems may experience a corruption issue
...
Limitations and Defects Found See the "Known Issues" on page 26 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
...
What’s New in Avid NEXIS 2025.5.0 Support for Windows 11 build 24H2 In this release, Avid adds support for Windows 11 build 24H2 with 1GbE, 2x1GbE, 10GbE, 2x10GbE, and 40GbE network adapters. See "Supported Client Operating Systems" on page 17 Monitoring and Reporting Memory Errors Avid NEXIS 2025.5.0 introduces a monitoring and notification feature that detects and reports memory errors in the Controllers and notifies the customers in the Management Console and via email (if enabled).
...
What’s New in Avid NEXIS 2025.2.2 Client Fixes SSENG-40594, SSENG-40601: CrowdStrike causes delay issues with Avid NEXIS clients, resulting in
...
See the "Known Issues" on page 26 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
...
What’s New in Avid NEXIS 2025.2.0 Support for macOS 15 Sequoia Clients with 1GbE and built-in 10GbE Network Adapters or 2 x 1GbE, and built-in 1 or 2 x 10GbE network adapters on Apple Silicon (M1, M2, M3, M4) and Intel- based Mac computers. See "Supported Client Operating Systems" on page 17 for more information.
Limitations and Defects Found See the "Known Issues" on page 26 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
...
What’s New in Avid NEXIS 2025.2.0 Support for Rocky Linux with 40GbE Connection This release adds support for on-premises Rocky Linux clients with 40GbE network adapters; see "Supported Client Operating Systems" on page 17 for more information.
...
USM Versions
> **Note:** Althoughnotrequired,customersusingmixedmediapackswithfullworkspacesthat
exceedtheeffectivecapacityareadvisedtoreducetheamountofdatainthoseworkspaces beforeupgradingto2025.2.Thishelpspreventdiscrepanciesintheinformationdisplayedon theManagementConsoledashboard.
...
USM Versions w USM upgrades are currently performed remotely by Avid; they do not happen automatically during system software upgrades. Contact Avid Global Customer Services for details. Some USM firmware versions are supported only with certain Avid NEXIS versions and models; see the following tables for details.
...
2024.11.0, 2025.2.2, 2025.5.1 (LA) c Delete all media from Avid NEXIS | Cloudspaces while your subscription is still System Director and Client Version Compatibility Platforms Current Avid NEXIS Version Can Upgrade Directly To active before upgrading to 2023.8.0 or higher.
Avid NEXIS | Cloud 2021.3.1 and newer 2025.5.3 Storage systems To upgrade Avid NEXIS | Cloud c Do not upgrade any Avid NEXIS Cloud Storage 2020.7.x and earlier Storage system to 2023.7.0, 2023.8.0, or to Avid NEXIS | FS version 2025.2.0.
...
Avid NEXIS Server and Client Compatibility Avid NEXIS Avid NEXIS Avid NEXIS Avid NEXIS Avid NEXIS Avid NEXIS 2022.x Client 2023.3 Client 2023.8 Client 2023.12 Client 2024.x Client2025.x Client Avid NEXIS 2022 N N N N server Avid NEXIS 2023.3 N N N N server Not Not Avid NEXIS 2023.8 recommended recommended N N N N server for new for new Avid NEXIS 2023.12 installations or installations or Y Y Y server Not upgrades upgrades Avid NEXIS 2024.x recommended for Y Y Y server new installations Avid NEXIS 2025.x or upgrades Y Y Y server Recommended Supported but not recommended for new systems Not supported. Upgrade core (server) to Avid NEXIS 2023.12 or newer ASAP System Director and Client Version Compatibility Recommended Version Avid NEXIS 2023.12 is the minimum recommended version that prevents media consistency errors. Newer versions include additional features and fixes. Avid recommends running the latest version of server and client due to the enhanced functionality, security enhancements, and fixes. For a complete list of features and fixes, see the "What's New" section of this ReadMe.
...
Operating Supported Versions Notes System macOS 15.3 (Sequoia) or later, on Apple Silicon (M1, n macOSclientsarenotsupportedon M2, M3, M4) and Intel-based Mac AvidNEXIS|CloudStorage(Azure computers with all supported NICs.
NearlineandOnline).
...
Rocky Linux v9.4 kernel 5.14.0-427.13.1 with 1GbE, Supported only on-premises Avid NEXIS 10GbE, and 40GbE NICs clients Compatible with AutoDesk Flame 2025 Ubuntu 22.04 To migrate MediaCentral | Cloud UX systems from CentOS to Ubuntu, see the MediaCentral Cloud UX Documentation.
...
Windows 11 build 24H2 See "Windows Issues" on page 29.
System Director and Client Version Compatibility Operating Supported Versions Notes System 11 build 23H2 10 build 22H2 Microsoft support for Windows 10 ends on October 14, 2025.
...
System Performance (On-Premises) Item Limit Files per folder Avid recommends no more than 10,000 files per folder, particularly for Workspaces used by Avid MediaCentral | Production Management.
...
System Performance (On-Premises) Scale-Out Performance The Scale-Out performance data in the following table is applicable to these models:
Avid NEXIS | PRO+
...
Media Pack Protection Read% Write% None One Disk Two Disk 100 0 700 MB/sec 700 700 90 10 700 691 683 80 20 700 683 667 70 30 700 675 651 60 40 700 667 636 50 50 700 659 622 System Performance (On-Premises) Media Pack Protection Read% Write% None One Disk Two Disk 40 60 700 651 609 30 70 700 644 596 20 80 700 636 583 10 90 700 629 571 0 100 700 622 560 Usable Storage 100% 89% 80% SSD Performance SSD Performance is the only bind option available on Avid NEXIS | F2 SSD Engines.
...
Known Issues Workaround: Close the error message and generate the logs again.
...
Known Issues SSENG-42693: On macOS client systems with many CPU cores, Adobe Premiere Pro Premiere can intermittently hang when importing P2 media from an Avid NEXIS workspace to the local drive. When this happens, you must reboot the workstation to completely clear the problem.
...
Windows Issues
> **Note:** MicrosoftsupportforWindows10endsonOctober14,2025.
...
Known Issues SSENG-29069: On Windows 10 clients, when using TeraCopy to move large numbers of files to an Avid NEXIS Workspace (instead of using Windows Explorer), TeraCopy sometimes treats a file as a directory, and the Windows client displays an error that it cannot move the file. Avid strongly recommends not using TeraCopy.
