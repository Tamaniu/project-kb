...
December 1, 2025 2025.5.1 Updated the Limited Availability and Upgrade notice in Avid NEXIS 2025.5.1.
...
August 4, 2025 2025.5.1 Added SSENG-44465 to the "Known Issues" on page 27.
...
Date Version Changes June 2, 2025 2025.2.2 Removed SSENG-42854, SSENG-43568, and SSENG-43596 from the Server Fixes section and moved them to the Known Issues section.
April 22, 2025 2025.2.2 See "What’s New in Avid NEXIS 2025.2.2" on page 11 April 7, 2025 2025.3.0 Added support for built-in 10GbE network adapters for macOS Sequoia clients.
March 25, 2025 2025.3.0 See "What’s New in Avid NEXIS 2025.3.0" on page 12 February 25, 2025 2025.2.0 Withdrawn due to an issue that may prohibit write operations. Fixed in Avid NEXIS | VFS 2025.2.2.
Contents What’s New in Avid NEXIS 2025.2.2 11 What’s New in Avid NEXIS 2025.3.0 12 What’s New in Avid NEXIS 2025.2.0 12 USM Versions 15 Hardware and Software Requirements 17 Supported Upgrade Paths 17 System Director and Client Version Compatibility 17 Compatibility with Other Avid Products 20 Third Party Editor Compatibility 20 System Configuration Limits 20 System Performance (On-Premises) 23 Known Issues 27 Special Notes 33 Accessing the Online Documentation The Avid online documentation contains all the product documentation in PDF format. You can access the documentation from the Knowledge Base site specific to your release. Download and install Acrobat Reader before you access the PDF documentation.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Clients (On- 2025.10.0 Support for Ubuntu 24.04 for on-premises clients; Support for Rocky Linux premises) clients in Avid NEXIS | Cloud Storage (Azure Nearline and Online); Avid NEXIS | Remote; Avid NEXIS Management API Documentation.
...
What’s New in Avid NEXIS 2025.10.0 Product Version Guidance Server and 2024.11.0 Native Apple Silicon support; Support for on-premises Rocky Linux clients; Clients Support for 600 active clients on Avid NEXIS | Cloud Storage systems; Bug fixes.
Server and 2024.10.0 Support for Windows 11 build 23H2; File delete logging; Bug fixes and Clients improvements.
This version is recommended for use with Avid Pro Tools. See "Compatibility with Other Avid Products" on page 20 Server and 2024.6.2 Resolved a continuous reboot issue and the installation dependencies in the Clients previous release.
...
This release adds support for Ubuntu 24.04 as a client operating system for on-premises Avid NEXIS systems with 1GbE, 10GbE, and 40GbE network connections. See "Supported Client Operating Systems" on page 18. For installation and configuration instructions, see the AvidNEXISClientManagerInstallation andUser'sGuideavailable in the Avid NEXIS Documentation Knowledge Base.
> **Note:** TheUbuntukitdoesnotsupporttheClientManagerGUI.
What’s New in Avid NEXIS 2025.10.0 Support for Rocky Linux Clients in Avid NEXIS | Cloud Storage (Azure Nearline and Online) Rocky Linux is now a supported client operating system for Avid NEXIS | Cloud Storage (Azure Nearline and Online). See "Supported Client Operating Systems" on page 18. For installation instructions, refer to the AvidNEXIS®ClientManagerInstallationandUser’sGuideavailable in the Avid NEXIS Documentation Knowledge Base.
...
Support for macOS 15 Sequoia Clients with 10GbE, 25GbE, and Higher Network Adapters Avid now fully supports macOS 15 Sequoia clients using 10GbE, 2x10GbE, 25GbE, 40GbE, and 100GbE external network adapters on Macs with Apple Silicon (M-series) or Intel chips. See "Supported Client Operating Systems" on page 18
...
For clients using Sonnet Twin10G SFP+ adapters, do not load the Sonnet kext driver package. Use the built-in Apple dext driver instead. For more details, see "Known Issues" on page 27.
Server Fixes
...
See the "Known Issues" on page 27 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
...
Support for Windows 11 build 24H2 In this release, Avid adds support for Windows 11 build 24H2 with 1GbE, 2x1GbE, 10GbE, 2x10GbE, and 40GbE network adapters. See "Supported Client Operating Systems" on page 18 Monitoring and Reporting Memory Errors Avid NEXIS 2025.5.0 introduces a monitoring and notification feature that detects and reports memory errors in the Controllers and notifies the customers in the Management Console and via email (if enabled).
...
Limitations and Defects Found See the "Known Issues" on page 27 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
...
Support for macOS 15 Sequoia Clients with 1GbE and built-in 10GbE Network Adapters or 2 x 1GbE, and built-in 1 or 2 x 10GbE network adapters on Apple Silicon (M1, M2, M3, M4) and Intel- based Mac computers. See "Supported Client Operating Systems" on page 18 for more information.
Limitations and Defects Found See the "Known Issues" on page 27 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
What’s New in Avid NEXIS 2025.2.0 Withdrawn due to an issue that may prohibit write operations. Avid recommends upgrading to Avid NEXIS | VFS version 2025.2.2 as soon as possible. All features and fixes introduced in 2025.2.0 are included in 2025.2.2.
...
Support for Rocky Linux with 40GbE Connection This release adds support for on-premises Rocky Linux clients with 40GbE network adapters; see "Supported Client Operating Systems" on page 18 for more information.
...
Platforms Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2025.5.3 2020.x, 2021.x, 2022.x, 2023.x, 2024.2.x, 2024.5.0, Do not upgrade any on-premises system to 2024.6.x, 2024.10.0, 2023.7.0, 2025.2.0, 2025.5.0.
2024.11.0, 2025.2.2, 2025.5.1 (LA) Delete all media from Avid NEXIS | Cloudspaces while your subscription is still active before upgrading to 2023.8.0 or higher.
...
Compatible with AutoDesk Flame 2025 Ubuntu 24.04 with 1GbE, 10GbE, and 40GbE NICs Ubuntu 24.04 is supported only on on- premises Avid NEXIS clients.
22.04 To migrate MediaCentral | Cloud UX systems from CentOS to Ubuntu, see the MediaCentral Cloud UX Documentation.
...
Windows 11 build 24H2 See "Windows Issues" on page 30.
11 build 23H2 10 build 22H2 Microsoft ended support for Windows 10 on October 14, 2025.
...
System Performance (On-Premises)
...
System Performance (On-Premises) On a Media Pack that is under full load (at complete bandwidth capacity), the minimum repair rate is 512KB/s. As the drive is rebuilt it begins contributing to the overall Media Pack performance rate for both reads and writes, so during the rebuild, the rate gradually decreases.
...
Avid NEXIS On-Premises Systems Issues SSENG-41851: An Avid NEXIS server and client compatibility issue has been identified that can cause media consistency issues when using Avid NEXIS 2023.8 or a newer client with Avid NEXIS 2023.8 or an older server. To prevent this, Avid recommends using Avid NEXIS v2023.12 or later for both the server and client. For more details, see the "System Director and Client Version Compatibility" on page 17.
...
yourworkstations.
NewSSENG-44903: Media transfers from Avid StreamIO to Avid NEXIS fail when using the Avid NEXIS Client for Ubuntu version 2025.10.0.
...
Known Issues (None): If the Client Manager is connected to an Avid NEXIS system with dual controllers and the System Director service has switched over to the second controller, the Management Console launch button in the Client Manager does not redirect to the new System Director and cannot successfully open the Management Console.
...
Avid NEXIS | Remote Issues NewSSENG-44449:
In Adobe Premiere Pro, an error dialog in the Avid NEXIS Remote Panel may remain open even after clicking OK.
...
Mac Platforms and macOS Issues SSENG-43073: When using Sonnet Twin10G SFP+ adapter with the latest kext driver on macOS 15 Sequoia, a kernel panic occurs during write operations to Avid NEXIS. However, this issue does not occur when using the built-in Apple dext driver.
...
Known Issues (None): The Avid NEXIS client on macOS by default disables Spotlight indexing for Avid NEXIS workspaces because Spotlight indexing does not scale well across large, shared file systems like Avid NEXIS.
