...
Fixed in Media Composer v2025.12.1 Avid Media Composer® ReadMe for Version 2025.12.1 Fixed in Media Composer v2025.12.1 The following have been fixed:
...
Fixed in Media Composer v2025.12.1 Bug Number: MCCET-6170. NDI streaming stopped working after repeatedly toggling the HW/SW output on and off.
...
Fixed in Media Composer v2025.12.1 Bug Number: MCCET-6193. Send to Playback performed an unnecessary audio mixdown in some instances.
...
Bug Number: MCCET-6273. Data tracks could not be moved in the timeline using the Trim Left or Trim Right keys.
Fixed in Media Composer v2025.12.1 Bug Number: MCCET-6245. WAV audio files with numbered suffixes failed to batch reimport and remained offline.
