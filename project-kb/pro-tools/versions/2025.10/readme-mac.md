...
PT-348968: Changing the Atmos monitoring format from the Renderer controls in the Edit Window toolbar does not work if there are soloed and muted tracks in the session after switching from the 360RA WalkMix renderer.
