...
| Date | Change |
|---|---|
| 01/05/2026 | Added MC \| Newsroom Management (iNEWS) compatibility data for Cloud UX v2021.11–v2020.4; sourced from MCNM server readmes |
...
> **Source note:** Cloud UX platform readme files for v2020.4–v2021.11 are not present in project-kb. Data in this section is derived from MCNM server readme files (v2020.4 through v2021.11.1). For full Cloud UX platform compatibility data for this era, consult the Avid MediaCentral Legacy matrix at https://kb.avid.com/pkb/articles/en_US/compatibility/Avid-Video-Compatibility-Charts.

| Component | v2021.11 | v2021.7 | v2021.3 | v2020.9.x | v2020.4 |
|---|---|---|---|---|---|
| **Release Date** | 19/11/2021 | 26/07/2021 | 13/05/2021 | ~Sep 2020 | 19/04/2020 |
| **OS — Linux (Cloud UX server)** | Not present in project-kb | Not present in project-kb | Not present in project-kb | Not present in project-kb | Not present in project-kb |
| **MC \| Newsroom Management (iNEWS)** | v2021.11 [a] | v2021.7 [b] | v2021.3 [c] | v2020.9.x | v2020.4 |
| **NM Server OS (RHEL/CentOS)** | RHEL 7.7/7.9; CentOS 7.7/7.9 | RHEL 7.7/7.9; CentOS 7.4/7.5/7.7/7.9 | RHEL 7.7/7.9; CentOS 7.7/7.9 | RHEL 7.7/7.9; CentOS 7.7/7.9 | RHEL 7.5/7.7; CentOS 7.5/7.7 |
| **iNEWS Workstation** | Windows 10 | Windows 10 | Windows 10 | Windows 10 | Windows 10 |
| **MOS Gateway** | v2021.11 (subscription licensing); v2021.3 or later (ULAT licensing) | v2021.3 or later | v2021.3 or later | Not present in project-kb | v4.0 or later |
| **Data Receiver** | v1.8 or later | v1.8 or later | Not present in project-kb | Not present in project-kb | v1.8 or later |
| **MC \| Command** | v1.0.1 or later | v1.0.1 or later; v3.2 required for VID-DURATION | v1.0.1 or later | Not present in project-kb | v1.0.1 or later; v3.2 required for VID-DURATION |
| **Avid NEXIS** | See Avid MediaCentral Legacy matrix | See Avid MediaCentral Legacy matrix | See Avid MediaCentral Legacy matrix | See Avid MediaCentral Legacy matrix | See Avid MediaCentral Legacy matrix |

a. Both MCNM and Cloud UX must be at v2021.11 simultaneously for Kafka compaction. Subscription licensing (v2021.11+) requires a new licence string from Avid; v2021.7 and earlier licence strings are incompatible. From v2021.11, the iNEWS Sync Agent no longer supports the Cloud UX HTTP interface; Kafka is the only supported method.

b. MCNM v2021.7 is compatible only with other v2021.7 components. The Real Name Display feature requires Cloud UX v2021.7 or later.

c. MCNM 2021.x clients cannot connect to 2020.x or earlier servers, and vice versa.
