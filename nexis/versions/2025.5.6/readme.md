...
Revision History Date Version Changes February 26, 2026 2025.5.6 Added a note clarifying that the features and fixes introduced in Avid NEXIS 2025.10.0 are not included in the 2025.5.6 release.
...
Date Version Changes June 4, 2025 2025.5.0 Withdrawn due to a write failure issue on Avid NEXIS | F5 systems configured with mirrored workspaces and link aggregation (LACP).
See "What’s New in Avid NEXIS 2025.5.0" on page 10 June 2, 2025 2025.2.2 Removed SSENG-42854, SSENG-43568, and SSENG-43596 from the Server Fixes section and moved them to the Known Issues section.
April 22, 2025 2025.2.2 See "What’s New in Avid NEXIS 2025.2.2" on page 12 April 7, 2025 2025.3.0 Added support for built-in 10GbE network adapters for macOS Sequoia clients.
...
Contents What’s New in Avid NEXIS 2025.5.0 10 What’s New in Avid NEXIS 2025.2.2 12 What’s New in Avid NEXIS 2025.3.0 13 What’s New in Avid NEXIS 2025.2.0 13 USM Versions 16 Hardware and Software Requirements 18 Supported Upgrade Paths 18 System Director and Client Version Compatibility 18 Compatibility with Other Avid Products 21 Third Party Editor Compatibility 21 System Configuration Limits 21 On-Premises System Performance 24 Cloud System Performance 27 Known Issues 30 Special Notes 36 Accessing the Online Documentation The Avid online documentation contains all the product documentation in PDF format. You can access the documentation from the Knowledge Base site specific to your release. Download and install Acrobat Reader before you access the PDF documentation.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Clients only 2025.5.6 Required for Media Composer 2025.12.0. See "What’s New in Avid NEXIS 2025.5.6" on the next page Server and 2025.5.5 Recommended version for on-premises systems only.
Clients Includes major bug fixes.
Clients (On- 2025.10.0 Support for Ubuntu 24.04 for on-premises clients; Support for Rocky Linux premises) clients in Avid NEXIS | Cloud Storage (Azure Nearline and Online); Avid NEXIS | Remote; Avid NEXIS Management API Documentation.
Server and Clients (Cloud) Server and 2025.5.3 Bug fixes. Fixed the performance regression issue found in Avid NEXIS | VFS Clients 2025.5.1.
...
What’s New in Avid NEXIS 2025.5.6 Product Version Guidance Server and 2025.2.0 Withdrawn due to an issue that may prohibit write operations. Fixed in Avid Clients NEXIS | VFS 2025.2.2.
...
This version is recommended for use with Avid Pro Tools. See "Compatibility with Other Avid Products" on page 21 Server and 2024.6.2 Resolved a continuous reboot issue and the installation dependencies in the Clients previous release.
...
> **Note:** FeaturesandfixesintroducedinAvidNEXISversion2025.10.0arenotincludedinthisrelease.
What’s New in Avid NEXIS 2025.10.0 Avid NEXIS version 2025.5.5 is a patch release for on-premises systems only. It includes the following fixes:
Server Fixes (in Numerical Order)
- SSENG-44038: After upgrading to Avid NEXIS 2025.2.2, the Storage Group and Workspace
...
- Segmentation fault error may occur, causing the System Director to restart. This issue happens
when the File Delete Logging feature is enabled and a deletion is suddenly interrupted.
- SSENG-44652, SSENG-44832, SSENG-44860, SSENG-44981, SSENG-44118, SSENG-45058:
Increasing client write bandwidth on mirrored Avid NEXIS systems breaks Media Pack connections, resulting in delayed write failures.
...
Limitations and Defects Found See the "Known Issues" on page 30 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
Windows 10 No Longer Supported Windows 10 is no longer supported in this release. See the "Supported Client Operating Systems" on page 19.
...
Support for Ubuntu 24.04 for on-premises Avid NEXIS Clients
...
This release adds support for Ubuntu 24.04 as a client operating system for on-premises Avid NEXIS systems with 1GbE, 10GbE, and 40GbE network connections. See "Supported Client Operating Systems" on page 19. For installation and configuration instructions, see the AvidNEXISClientManagerInstallation andUser'sGuideavailable in the Avid NEXIS Documentation Knowledge Base.
> **Note:** TheUbuntukitdoesnotsupporttheClientManagerGUI.
What’s New in Avid NEXIS 2025.10.0 Support for Rocky Linux Clients in Avid NEXIS | Cloud Storage (Azure Nearline and Online) Rocky Linux is now a supported client operating system for Avid NEXIS | Cloud Storage (Azure Nearline and Online). See "Supported Client Operating Systems" on page 19. For installation instructions, refer to the AvidNEXIS®ClientManagerInstallationandUser’sGuideavailable in the Avid NEXIS Documentation Knowledge Base.
...
Removal of CentOS Installers The Avid NEXIS | VFS Gateway and Avid NEXIS Client installers for CentOS have been removed from both the installer kit and the Installers page in the Management Console.
...
What’s New in Avid NEXIS 2025.5.3 Client Fixes SSENG-44092: On Windows 11 24H2 machines with Avid NEXIS Client version 2025.5.x, a dialog
- box appears with the following message: "Program Compatibility Assistant: This module is blocked
from loading into the Local Security Authority. \Device\HarddiskVolume5\Windows\System32\ AvidFosNP.dll" Limitations and Defects Found See the "Known Issues" on page 30 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
What’s New in Avid NEXIS 2025.5.3 Avid NEXIS version 2025.5.3 is a patch release that includes the following fixes:
Server Fixes (in Numerical Order)
- SSENG-44465: In Avid NEXIS 2025.5.1, media mirror writes fail when an Avid NEXIS | F2 Storage
engine (F2/F2X) is configured with LACP (Link Aggregation Control Protocol) and auto-negotiated 25Gbps network links.
...
- new Effective capacity is less than the total capacity already allocated to workspaces, the system
triggers an assert error. With this fix, the system will instead return a "Failed: Reservation exceeds Storage Group capacity" error.
Client Fixes SSENG-44473, SSENG-44492: The avidfos service crashes on Avid NEXIS clients. This issue is
- caused by multiple threads rapidly opening and closing directories, a pattern often triggered by
third-party file transfer applications.
Windows 10 End of Support Avid will no longer support Windows 10 after Microsoft's end-of-support date on October 14, 2025. Since Microsoft will stop providing security updates, Avid recommends that you upgrade to Windows 11 to ensure continued support and security.
...
What’s New in Avid NEXIS 2025.5.0 Support for 2x100GbE Controller for Avid NEXIS | F5 Avid qualifies the 2x100GbE Controller for use with Avid NEXIS | F5. This Controller requires a minimum version of Avid NEXIS | VFS 2025.5.1 and supports a maximum network speed of 50Gbps.
...
Support for macOS 15 Sequoia Clients with 10GbE, 25GbE, and Higher Network Adapters Avid now fully supports macOS 15 Sequoia clients using 10GbE, 2x10GbE, 25GbE, 40GbE, and 100GbE external network adapters on Macs with Apple Silicon (M-series) or Intel chips. See "Supported Client Operating Systems" on page 19
...
For clients using Sonnet Twin10G SFP+ adapters, do not load the Sonnet kext driver package. Use the built-in Apple dext driver instead. For more details, see "Known Issues" on page 30.
Server Fixes
- SSENG-42854, SSENG-43568, SSENG-43569: Some systems may experience a corruption issue
affecting media (video, audio, etc.) captured from FastServe and transferred remotely to an on- premises Avid NEXIS system with mirrored workspaces. The issue occurred under certain network error conditions while servicing Edit While Capture (EWC) workflows.
- SSENG-44095: After upgrading to Avid NEXIS | VFS 2025.5.0, an issue with aggregated link speed
reporting has been observed, causing write failures on Avid NEXIS | F5 systems configured with mirrored workspaces and link aggregation (LACP) enabled.
SSENG-41138, SSENG-41140, SSENG-42694: Enhanced security for the Avid NEXIS | VFS.
- Limitations and Defects Found
See the "Known Issues" on page 30 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
...
What’s New in Avid NEXIS 2025.5.0 Support for Windows 11 build 24H2
...
Support for Windows 11 build 24H2 In this release, Avid adds support for Windows 11 build 24H2 with 1GbE, 2x1GbE, 10GbE, 2x10GbE, and 40GbE network adapters. See "Supported Client Operating Systems" on page 19 Monitoring and Reporting Memory Errors Avid NEXIS 2025.5.0 introduces a monitoring and notification feature that detects and reports memory errors in the Controllers and notifies the customers in the Management Console and via email (if enabled).
...
What’s New in Avid NEXIS 2025.2.2 The Avid NEXIS Client for AL2 remains available and supported until further notice. You can upgrade older versions of the Client Manager on AL2 to Avid NEXIS Client 2025.5.0. See "Supported Client Operating Systems" on page 19 See the Avid NEXIS | VFS Cloud Software for links to the landing pages for this and other Cloud releases on AWS.
...
What’s New in Avid NEXIS 2025.3.0 Server Fixes SSENG-37037, SSENG-37518: The LDAP server stopped responding to authentication requests
- resulting in user authentication failures that prevent users from logging into Avid NEXIS via Remote
LDAP.
...
- the Effective, Allocated, and Unallocated fields, as well as some workspaces, show zero capacity,
prohibiting write operations.
Client Fixes
...
clients for Ubuntu and Rocky Linux that would block the opening of directories after a period of operation. On affected Linux clients, this could manifest as 'Cannot Allocate Memory' errors, slow performance, disconnections, or media offline.
...
Support for macOS 15 Sequoia Clients with 1GbE and built-in 10GbE Network Adapters or 2 x 1GbE, and built-in 1 or 2 x 10GbE network adapters on Apple Silicon (M1, M2, M3, M4) and Intel- based Mac computers. See "Supported Client Operating Systems" on page 19 for more information.
Limitations and Defects Found See the "Known Issues" on page 30 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
...
What’s New in Avid NEXIS 2025.2.0 Larger drive capacities for Avid NEXIS F2/F2X, F5, and F5 | NL
...
Support for Rocky Linux with 40GbE Connection This release adds support for on-premises Rocky Linux clients with 40GbE network adapters; see "Supported Client Operating Systems" on page 19 for more information.
...
an incomplete menu in the navigation sidebar and only shows a single engine without an active System Director.
SSENG-40046: Avid NEXIS editing clients running on Windows with Microsoft Defender for Endpoint
- may experience workflow failures if Microsoft Defender for Endpoint holds a file open while the
editing application attempts to delete it on drive letter Avid NEXIS mounts. This has prevented proper operation of Send-to-playback workflows.
...
issue is fixed in the following feature "Support for Custom Icons on macOS Folders" above
...
- v2024.11.0.
USM Versions SSENG-42028: When installing the Avid NEXIS Object Access Module (OAM) package on Rocky
...
Server and Client Fixes SSENG-28342, 34868, 36932, 38433: Unable to delete folders with a large number of files on
- macOS. When deleting a folder or directory from Avid NEXIS workspaces via Finder, this error
message appears: "The operation can't be completed because the item is in use". This issue is resolved by upgrading both the Avid NEXIS server and client to v2025.2.0.
Limitations and Defects Found See the "Known Issues" on page 30 for all limitations found in this release and previous releases. New limitations are marked as 'New'.
...
> **Note:** AvidNEXIScurrentlysupportsCrowdStrikeversion7.24.
...
Platforms Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2025.5.5 2020.x, 2021.x, 2022.x, 2023.x, 2024.2.x, 2024.5.0, Do not upgrade any on-premises system to 2024.6.x, 2024.10.0, 2023.7.0, 2025.2.0, or 2025.5.0.
2024.11.0, 2025.2.2, 2025.5.1 (LA), 2025.5.3 Delete all media from Avid NEXIS | Cloudspaces while your subscription is still active before upgrading to 2023.8.0 or higher.
...
2021.x, please contact Avid Customer Service or your sales c Avid NEXIS | Cloud Storage systems on AWS representative to assist with running version 2025.2.x and earlier cannot the upgrade.
be upgraded to 2025.5.0 or higher.
...
System Director and Client Version Compatibility Although rare, it may cause portions of media to be unreadable. Avid strongly recommends that customers upgrade the Avid NEXIS core to the minimum recommended version of Avid NEXIS 2023.12 immediately.
...
Operating Supported Versions Notes System macOS 15.7.1 (Sequoia) or later, on Apple Silicon n macOSclientsarenotsupportedon (M1, M2, M3, M4) and Intel-based Mac AvidNEXIS|CloudStorage(Azure System Director and Client Version Compatibility Operating Supported Versions Notes System computers with all supported NICs.
NearlineandOnline).
...
Compatibility with Other Avid Products Refer to the MediaCentral Compatibility Matrix for version compatibility between the Avid NEXIS Client and MediaCentral | Cloud UX.
...
System Configuration Limits On-Premises Limits Item Embedded System Director System Director Appliance Media Packs (per 4, in any combination of Scale-Out and 8 in a High Performance Storage Group system) High Performance 24 total (optionally including up to 8 in a High Performance Storage Group) with the Avid NEXIS | VFS Standard or Avid NEXIS | FS Standard license and any combination of Avid NEXIS Engines 64 total (optionally including up to 8 in a High Performance Storage Group) with the Avid NEXIS | VFS Advanced or Avid NEXIS | FS Advanced license, and any combination of Avid NEXIS Engines Media Packs (per 1 in all 2U chassis (Avid NEXIS | E2, Avid NEXIS | E2 All-Mirror, Avid NEXIS | E2 SSD, Avid Engine) NEXIS | PRO, Avid NEXIS | F2, Avid NEXIS | F2X, Avid NEXIS | PRO+) 1-2 in Avid NEXIS | F2 SSD 1–2 in all 4U chassis (Avid NEXIS | E4, Avid NEXIS | E4 All-Mirror) 4–8 in all 5U chassis (Avid NEXIS | E5, Avid NEXIS | E5 NL, Avid NEXIS | E5 All-Mirror, Avid NEXIS | F5, Avid NEXIS | F5 NL) Storage Groups 4, optionally including one High 32, optionally including one High Performance Storage Group Performance Storage Group Workspaces 1024 (including Workspaces for Teams) 3072 (including Workspaces for Teams) Teams 19 80 Team Quotas Up to 255 Team Quotas per system (Teams have only one quotaperStorage Group — which can be increased or decreased — but can have a quota in multiple Storage Groups) Team Admin Users No enforced limit Users (Clients) 5640 (including Users in Teams) User Groups 1028 (including User Groups in Teams) Group Non-Team users can belong to 71 non-Team user groups Memberships per Team users can belong to 71 user groupsinthesameTeam User Connected 40 with Avid NEXIS E-Series/F-Series 165 with Avid NEXIS | VFS Standard or Avid (Active) Clients Engines NEXIS | FS Standard license 30 with Avid NEXIS | PRO or Avid NEXIS | 330 with Avid NEXIS | VFS Advanced or PRO+ Avid NEXIS | FS Advanced license Up to 10 to a High Performance Storage Group (Avid strongly recommends no more than 10) Files and Folders 8 million in Avid NEXIS E-series/F-Series 175 million in configurations with an Avid configurations NEXIS | SDA+ and the Avid NEXIS | FS Advanced license running Avid NEXIS System Configuration Limits Item Embedded System Director System Director Appliance 5 million in configurations where the version 2023.8.0 or higher System Director service runs on an Avid 28.4 million in configurations with an Avid NEXIS | PRO+ NEXIS | SDA or Avid NEXIS | SDA+ with the 3 million in configurations where the Avid NEXIS | FS Standard license.
System Director service runs on Avid NEXIS
> **Note:** | PRO
Actuallimitdependsonfilename length.Limitassumes67ASCII
...
Cloud System Performance On a Media Pack that is under full load (at complete bandwidth capacity), the minimum repair rate is 512KB/s. As the drive is rebuilt it begins contributing to the overall Media Pack performance rate for both reads and writes, so during the rebuild, the rate gradually decreases.
Performance Rebuild Rate (Media Pack at 100% Drive Size Estimated Rebuild Time Type capacity) Scale-Out 48MB/sec 4TB 24 hours 0.17TB/hr or ~6hr/TB 6TB 36 hours 10TB 60 hours 14TB 84 hours 16TB 96 hours High 70MB/sec 4TB 16 hours 6TB 24 hours 0.25TB/hour, or ~4 hr/TB 10TB 40 hours 14TB 56 hours SSD 700MB/sec 3.48TB ~1.3 hours 2.52TB/hour, or ~24 min/TB 15.3TB ~6 hours
...
Cloud System Performance Workflow Types and Virtual Machine Sizes Virtual Machines come in different types and sizes to accommodate various editing workflows. The following table outlines the differences between Small, Medium, Large, and Extra Large workflow types, along with the corresponding VM configurations for each.
...
Avid NEXIS | Cloud Nearline Storage Operating System Read Bandwidth (MB/s) Write Bandwidth (MB/s) Azure AWS Azure AWS Linux - 80 - 100 Windows 350 80 250 100 macOS n/a 80 n/a 100 Cloud System Performance Avid NEXIS | Cloud Online Storage Operating System Read Bandwidth (MB/s) Write Bandwidth (MB/s) Azure AWS Azure AWS Linux 650 2250 850 1250 Windows 900 1100 900 1750 macOS n/a 1100 n/a 950 Playback Performance This section presents the playback performance in Media Composer, comparing different codecs— both native and foreign compression, and the number of streams supported across various VM sizes.
AWS Playback Performance Codec Stream Count per VM Size S M L XL HD UHD Foreign Compression Known Issues Known Issues The following are known issues with Avid NEXIS software or third-party vendors. When a workaround exists, it appears in the paragraph directly following the issue description.
...
SSENG-36923: You might see an error about the license directory being usnavailable when trying to activate a license on a newly deployed Avid NEXIS | Cloud Storage system.
