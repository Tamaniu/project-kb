...
Revision History Date Release Changes
...
"Supported Client Operating Systems " on page 10
- Revised the Aggregate Performance and Drive Rebuild numbers for
F2 SSD systems (see "SSD Performance Updated values April 2023" on page 16 and "Drive Rebuilds and System Performance Updated SSD values April 2023" on page 17) Contents System Director and Client Version Compatibility 10 Supported Client Operating Systems 10 CentOS Version Compatibility with Avid NEXIS Client and VFS Gateway Versions 11 Supported Browsers in an Avid NEXIS On-Premises Environment 11 Compatibility with Other Avid Products 11 Third Party Editor Compatibility 12 System Configuration Limits 13 System Performance (On-Premises) 15 Known Issues 17 Special Notes 23 Qualified and Approved Avid NEXIS Switches 23 Flow Control Required in Avid Production Networks 23 ATTO® ThunderLink™ 10 GbE and 40 GbE Adapters 23 VMware ESXi™ 23 VMware on Windows 24 Legal Notices 25 Accessing the Online Documentation The Avid NEXIS documentation is accessible in PDF format from the Avid NEXIS Knowledge Base.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Server and Clients 2023.7.0 Recommended for all Avid NEXIS systems and clients.
Introduced modular licenses for F-Series Engines and the PRO+; see "What’s New in Avid NEXIS 2023.7.0" on page 6 for more information.
Server and Clients 2023.3.0 Introduced Avid NEXIS | F2 SSD.
See "What's New in Avid NEXIS Version 2023.3.0" on page 7 for more information.
...
Servers and 2022.5.0 Update July 2022: Required for all systems that include Avid NEXIS Clients F-Series engines or Avid NEXIS | PRO+ Required for all systems using subscriptions, and clients running macOS® 12 (Monterey) or Windows® 11.
Avid NEXIS version 2021.8 and older are no longer recommended and may no longer be supported. Upgrade as soon as possible.
...
What’s New in Avid NEXIS 2023.7.0 Avid NEXIS version 2023.7.0 is a major release that supports the following.
...
Modular Licensing FAQs Upgrading an existing shared-storage system to Avid NEXIS v2023.7.0 does not require any changes
...
- still require a capacity license (to enable the System Director functionality and either Flexible or All-
...
End of Support for Avid NEXIS | Cloudspaces (Amended August 2023) The Avid NEXIS Cloudspaces feature is no longer supported in version 2023.7.0. It will continue to appear in the Management Console until further notice.
...
All time fields in the Agent and the Management Console require 24-hour format. For example, to enter a time of 4:00 PM, enter 16:00, not 04:00. The Avid NEXIS documentation now contains this information.
- Supports a new licensing model for Avid NEXIS | Cloud Storage systems. Existing Avid NEXIS | Cloud
Storage systems can be upgraded to version 2023.3.0 to take advantage of this new support. Before the upgrade, the Management Console contains a button to deactivate the current license. After the upgrade, that button is no longer displayed. After you upgrade to this version, your system will need a new license if you want to change the capacity or the renewal date. (See also "Avid NEXIS | Cloud Storage Issues" on page 19.)
...
Number of Media Packs Total Engine Capacity License Capacity 1 38.4TB 39TB 2 76.8TB 78TB 1 153.6TB 154TB 2 307.2TB 308TB The Avid NEXIS | F2 SSD can also be added to an existing shared-storage system where another Engine runs the embedded System Director, or one that uses a System Director Appliance.
The documentation has been updated to fully describe this new model and how it can be used.
Server Fixes in This Release SSENG-33705 Avid NEXIS | F5 NL systems now support LACP.
- SSENG-34136 Corrected a discrepancy between the system time as set in the Agent during initial
- setup and the time displayed in the Management Console on the fully-configured system. This
mismatch occurred only on Avid NEXIS F-Series, Avid NEXIS | PRO+, and Avid NEXIS | SDA+ models and in some cases inactivated the license.
...
Current Avid NEXIS Version Can Upgrade Directly To On-premises systems: 6.x, 7.x, 2018.x, 2019.x, 2020.x, 2021.x, 2023.7.0 2022.x, 2023.3.0 Do not upgrade a system with a current or expired Cloudspaces subscription to Current Avid NEXIS Version Can Upgrade Directly To 2023.7.0. Contact support for more information.
Avid NEXIS | Cloud Storage systems: 2021.3.1 and newer 2023.7.0 To upgrade Avid NEXIS | Cloud Storage 2020.7.x and earlier to Avid NEXIS | FS version 2021.x, please contact Avid Customer Service or your sales representative to assist with the upgrade.
...
CentOS 7.9, 7.8, 7.7, 7.6 General Avid NEXIS Client use 7.5, kernel 4.4.174-1.el7 Supported only on MediaCentral | Cloud UX systems running CentOS 7.5 7.5, kernel 3.10.0-862.el7.x86_64 See the Avid Audio and Video Compatibility Charts on the Avid Knowledge Base page for more information on compatibility.
...
Operating Supported Versions Notes System To migrate MediaCentral | Cloud UX systems running CentOS to Ubuntu, see the MediaCentral Cloud UX Documentation.
Windows 11 build 21H2 10 Build 21H2 See "Windows 10 Issues" on page 21.
10 Build 21H1 10 Build 20H2 (October 2020) 10 Build 2004 (May 2020) Windows Server 2022 with latest Service Pack 2019 with latest Service Pack CentOS Version Compatibility with Avid NEXIS Client and VFS Gateway Versions The following versions of CentOS support the specified versions of the Avid NEXIS Client software and the Avid NEXIS | VFS Gateway (formerly Avid NEXIS | Linux File Gateway) software.
...
2 As of Final Cut Pro X10.4, you can store library files on Avid NEXIS instead of on local drives.
...
On-Premises Limits Item Embedded System Director System Director Appliance Media Packs (per 4, in any combination of 8 in a High Performance Storage Group system) Scale-Out and High 24 total (optionally including up to 8 in a High Performance Performance Storage Group) with the Avid NEXIS | VFS Standard or Avid NEXIS | FS Standard license and any combination of Avid NEXIS Engines 64 total (optionally including up to 8 in a High Performance Storage Group) with the Avid NEXIS | VFS Advanced or Avid NEXIS | FS Advanced license, and any combination of Avid NEXIS Engines Media Packs (per 1 in all 2U chassis (Avid NEXIS | E2, Avid NEXIS | E2 All-Mirror, Avid NEXIS | E2 SSD, Avid NEXIS | Engine) PRO, Avid NEXIS | F2, Avid NEXIS | F2X, Avid NEXIS | PRO+) 1-2 in Avid NEXIS | F2 SSD 1–2 in all 4U chassis (Avid NEXIS | E4, Avid NEXIS | E4 All-Mirror) 4–8 in all 5U chassis (Avid NEXIS | E5, Avid NEXIS | E5 NL, Avid NEXIS | E5 All-Mirror, Avid NEXIS | F5, Avid NEXIS | F5 NL) Storage Groups 4, optionally including one 32, optionally including one High Performance Storage High Performance Storage Group Group Workspaces 1024 (including Workspaces 3072 (including Workspaces for Teams) for Teams) Teams 19 80 Team Quotas Up to 255 Team Quotas per system (Teams have only one quota per Storage Group — which can be increased or decreased — but can have a quota in multiple Storage Groups) Team Admin No enforced limit Users Users (Clients) 5640 (including Users in Teams) User Groups 1028 (including User Groups in Teams) Group Non-Team users can belong to 71 non-Team user groups Memberships per Team users can belong to 71 user groups in the same Team User Connected 40 (Avid NEXIS E-Series/F- 165 with Avid NEXIS | VFS Standard or Avid NEXIS | FS (Active) Clients Series Engines) Standard license 30 (Avid NEXIS | PRO or Avid 330 with Avid NEXIS | VFS Advanced or Avid NEXIS | FS NEXIS | PRO+) Advanced license Item Embedded System Director System Director Appliance Up to 10 to a High Performance Storage Group (Avid strongly recommends no more than 10) Files and Folders 8 million (Avid NEXIS E- 28.4 million series/F-Series configurations,
> **Note:** running supported Avid NEXIS (Actual limit depends on file name length. Limit
versions up to 2023.7.0) assumes 67 ASCII characters (67 bytes). Longer average file names reduce the file count limit.) 3 million (Avid NEXIS | PRO/Avid NEXIS | PRO+ configurations) Files per folder Avid recommends no more than 5000 files per folder in Workspaces.
