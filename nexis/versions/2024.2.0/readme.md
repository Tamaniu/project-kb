...
Revision History Release Date Version Changes Contents Compatibility with Other Avid Products 10 Third Party Editor Compatibility 10 System Configuration Limits 10 System Performance (On-Premises) 12 Known Issues 16 Special Notes 21 Legal Notices 22 Accessing the Online Documentation The Avid NEXIS documentation is accessible in PDF format from the Avid NEXIS Knowledge Base.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Server and 2024.2.0 Recommended all Avid NEXIS systems (on-premises and Cloud).
Clients Required for macOS Sonoma (Avid NEXIS Client version 2024.2.0) Server and 2023.12.0 Strongly recommended minimum version for Pro Tools and Avid NEXIS in Clients audio workflows and all F2 SSD engines.
Recommended for all Avid NEXIS | EDGE sites See "What’s New in Avid NEXIS 2023.12" on page 1.
Windows 2023.8.3 Minimum required version for all installations using Crowdstrike. See "What’s Clients only New in Avid NEXIS 2023.8.3" on page 1.
Server and 2023.8.x Support for 175M files on SDA+ and 5M on Avid NEXIS PRO+ Clients Required minimum revision for Modular licenses Required minimum for all Avid NEXIS | EDGE sites See "What’s New in Avid NEXIS 2023.8.2" on page 1.
Server and 2023.3.0 Introduced Avid NEXIS | F2 SSD.
Clients See "What's New in Avid NEXIS Version 2023.3.0" on page 1 for more information.
Last supported version for customers using Avid NEXIS | Cloudspaces-- do not upgrade to any newer version Server and 2022.12.0 Minimum recommended version for all Avid NEXIS systems (E-series and F- Clients Series) Avid NEXIS Version Downgrades Installing an older software version on Avid NEXIS systems is not supported and can result in unforeseen consequences, up to and including data loss.
...
Avid NEXIS | Cloud Storage system support for 330 Simultaneous (Active) Clients This release increases the number of clients that can be connected to an Avid NEXIS | Cloud Storage system at the same time, all of which are active. See "Cloud System Limits" on page 12 for more information.
...
same USM version.
1.37a 0.01.0041 2019.2.0 Avid NEXIS E-series, Avid NEXIS | PRO 40TB with Controller 10 1.37 0.01.003c 2019.2.0 n Can use USM 1.37 and 1.37a in the same Engine for models that support dual controllers 4.1.16g 2.00.1093c 2019.2.0 Avid NEXIS | PRO 20TB , Avid NEXIS | PRO 40TB with purple fascia Controller 4.1.16d 2.0.0002 1.32 0.01.0034 7.9.1 Legacy Avid NEXIS E-series 1.16 0.01.0013 6.x Legacy Avid NEXIS E-series 1USM versions are shown on the Engines page and the Controllers page in the Management Console.
...
Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2024.2.0 2020.x, 2021.x, 2022.x, 2023.x Do not upgrade any on-premises system to 2023.7.0.
Do not upgrade any system that has or has previously had Avid NEXIS | Cloudspaces to 2023.8.0 or higher.
Avid NEXIS | Cloud 2021.3.1 and newer 2024.2.0 Storage systems To upgrade Avid NEXIS | Cloud c Do not upgrade any Avid NEXIS Cloud Storage Storage 2020.7.x and earlier system to 2023.7.0 or 2023.8.0.
...
Operating Supported Versions Notes System macOS 14 (Sonoma) with latest updates for Silicon n macOS clients are not supported with M1 and M2 computers with 1GbE NICs.
Avid NEXIS | Cloud Storage systems.
13.x (Ventura) with latest updates 12.x (Monterey) with latest updates 11.x (Big Sur) with latest updates CentOS 7.9, 7.8, 7.7, 7.6 General Avid NEXIS Client use 7.5, kernel 4.4.174-1.el7 Supported only on MediaCentral | Cloud UX systems running CentOS 7.5 7.5, kernel 3.10.0-862.el7.x86_64 See the Avid Audio and Video Compatibility Charts on the Avid Knowledge Base page for more information on compatibility.
...
See "Ubuntu Client and MediaCentral Compatibility" on the next page Windows 11 build 22H2 11 build 21H2 See "Windows 10 Issues" on page 19.
10 build 22H2 Windows Server 2022 with latest Service Pack Operating Supported Versions Notes System 2019 with latest Service Pack Ubuntu Client and MediaCentral Compatibility Avid NEXIS version 2023.3.0 was the first release to support Ubuntu for clients, intended to accommodate the move of MediaCentral | Cloud UX from CentOS to Ubuntu Linux. Performance was limited to 1Gb/s regardless of the physical connection, which was consistent with previous versions but slower than optimal.
...
Item Embedded System Director System Director Appliance 4–8 in all 5U chassis (Avid NEXIS | E5, Avid NEXIS | E5 NL, Avid NEXIS | E5 All-Mirror, Avid NEXIS | F5, Avid NEXIS | F5 NL) Storage Groups 4, optionally including one High 32, optionally including one High Performance Storage Group Performance Storage Group Workspaces 1024 (including Workspaces for Teams) 3072 (including Workspaces for Teams) Teams 19 80 Team Quotas Up to 255 Team Quotas per system (Teams have only one quota per Storage Group — which can be increased or decreased — but can have a quota in multiple Storage Groups) Team Admin Users No enforced limit Users (Clients) 5640 (including Users in Teams) User Groups 1028 (including User Groups in Teams) Group Non-Team users can belong to 71 non-Team user groups Memberships per Team users can belong to 71 user groups in the same Team User Connected (Active) 40 with Avid NEXIS E-Series/F-Series 165 with Avid NEXIS | VFS Standard or Avid Clients Engines NEXIS | FS Standard license 30 with Avid NEXIS | PRO or Avid NEXIS | 330 with Avid NEXIS | VFS Advanced or Avid PRO+ NEXIS | FS Advanced license Up to 10 to a High Performance Storage Group (Avid strongly recommends no more than 10) Files and Folders 8 million in Avid NEXIS E-series/F-Series 175 million in configurations with an Avid configurations NEXIS | SDA+ and the Avid NEXIS | FS Advanced license running Avid NEXIS 5 million in configurations where the version 2023.8.0 or higher System Director service runs on an Avid NEXIS | PRO+ 28.4 million in configurations with an Avid NEXIS | SDA or Avid NEXIS | SDA+ with the 3 million in configurations where the Avid NEXIS | FS Standard license.
...
Mac Platforms and macOS Issues Issue Number SSENG-39619: Customized macOS folder icons are not supported in the Avid NEXIS file system.
Issue Number: None. Avid NEXIS does not by default support using Spotlight search on Workspaces, and does not recommend using it.
Issue Number SSENG-23026, Updated August 2021: Avid Benchmark Utility does not work automatically on Avid NEXIS clients running macOS 11.x (Big Sur) and newer. On these clients, you must explicitly allow permission for an application (including Avid Benchmark Utility) to have Full Disk Access.
