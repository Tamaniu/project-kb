...
Revision History Release Date Version Changes Contents Security Guidelines 10 Secure Data Deletion 10 Hardware and Software Requirements 10 Supported Upgrade Paths 10 System Director and Client Version Compatibility 11 Supported Client Operating Systems 11 Ubuntu Client and MediaCentral Compatibility 12 CentOS Version Compatibility with Avid NEXIS Client and VFS Gateway Versions 12 Supported Browsers in an Avid NEXIS 13 Compatibility with Other Avid Products 13 Third Party Editor Compatibility 13 System Configuration Limits 13 System Performance (On-Premises) 16 Known Issues 21 Special Notes 25 Legal Notices 27 Accessing the Online Documentation The Avid online documentation contains all the product documentation in PDF format. You can access the documentation from the Knowledge Base site specific to your release. Download and install Acrobat Reader before you access the PDF documentation.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Server and 2024.5.0 Recommended for all Avid NEXIS systems (on-premises and Cloud).
...
Avid NEXIS | Cloud Storage system support for 330 Simultaneous (Active) Clients This release increases the number of clients that can be connected to an Avid NEXIS | Cloud Storage system at the same time, all of which are active. See "Cloud System Limits" on page 16 for more information.
...
Platforms Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2024.5.0 2020.x, 2021.x, 2022.x, 2023.x, 2024.2.x Do not upgrade any on-premises system to 2023.7.0.
...
Avid NEXIS | Cloud 2021.3.1 and newer 2024.5.0 Storage systems To upgrade Avid NEXIS | Cloud c Do not upgrade any Avid NEXIS Cloud Storage Storage 2020.7.x and earlier system to 2023.7.0 or 2023.8.0.
...
See "Ubuntu Client and MediaCentral Compatibility" below Windows 11 build 22H2 11 build 21H2 See "Windows 10 Issues" on page 24.
...
Requirement: On the macOS client, click System Preferences > Security & Privacy > Privacy > Full Disk Access avidbenchmarkd.
