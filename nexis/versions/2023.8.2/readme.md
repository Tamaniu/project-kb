...
Revision History Date Version Changes Oct. 11, 2023 2023.8.1 New issue identified; see "Known Issues" on page 22 Oct. 6, 2023 2023.8.1 Added new section for Avid NEXIS | EDGE fixes. "What’s New in Avid Jul. 31, 2023 2023.7.0 Withdrawn due to incorrect read issue; fixed in 2023.8.0.
...
> **Note:** For customers with current or lapsed Cloudspaces subscriptions,
see "End of Support for Avid NEXIS | Cloudspaces (Amended August 2023)" on page 10 Apr. 25, 2023 2023.3.0 Updates:
- Added support for macOS 13 (Ventura) for client systems; see
"Supported Client Operating Systems " on page 14 Revised the Aggregate Performance and Drive Rebuild numbers
- for F2 SSD systems (see "SSD Performance Updated values April
2023" on page 20 and "Drive Rebuilds and System Performance Date Version Changes Updated SSD values April 2023" on page 21) Mar. 28, 2023 2023.3.0 See "What's New in Avid NEXIS Version 2023.3.0" on page 11 Contents What’s New in Avid NEXIS 2023.7.0 10 What's New in Avid NEXIS Version 2023.3.0 11 Updated Security Guidelines 13 Secure Data Deletion 13 Hardware and Software Requirements 13 Supported Upgrade Paths 13 System Director and Client Version Compatibility 14 Supported Client Operating Systems 14 CentOS Version Compatibility with Avid NEXIS Client and VFS Gateway Versions 15 Supported Browsers in an Avid NEXIS On-Premises Environment 15 Compatibility with Other Avid Products 15 Third Party Editor Compatibility 16 System Configuration Limits 17 System Performance (On-Premises) 19 Known Issues 22 Special Notes 27 Legal Notices 29 Accessing the Online Documentation The Avid NEXIS documentation is accessible in PDF format from the Avid NEXIS Knowledge Base.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Server and Clients 2023.8.x Version 2023.8.2 is recommended for all Avid NEXIS systems (on- premises and Cloud).
Support for 175 million files with SDA+, 5 million files with PRO+; support for Windows 10 Build 22H2. Fixes for issues in 2023.8.0 and 2023.8.1.
See "What’s New in Avid NEXIS 2023.8.2" on page 7.
See also "What’s New in Avid NEXIS 2023.8.1" on page 7 and "What’s New in Avid NEXIS 2023.8.0 (On-Premises Only)" on page 9.
Server and Clients 2023.7.0 Withdrawn. All Avid NEXIS | PRO+ and Avid NEXIS F-Series customers running version 2023.7.0 must upgrade to 2023.8.1 as soon as possible.
Introduced modular licenses for F-Series Engines and the PRO+; see "What’s New in Avid NEXIS 2023.7.0" on page 10 for more information.
Server and Clients 2023.3.0 Introduced Avid NEXIS | F2 SSD.
See "What's New in Avid NEXIS Version 2023.3.0" on page 11 for more information.
Server and Clients 2022.12.0 Minimum version for all Avid NEXIS | EDGE workflows.
- Support for Windows Server 2022 on clients
- Final USM upgrade for Enterprise, SDA, and PRO systems
Server and Clients 2022.9.0 l Licensing improvements and updates
...
> **Note:** Server and Clients 2022.5.0
Oldest supported version.
Product Version Guidance Update July 2022: Required for all systems that include Avid NEXIS F-Series engines or Avid NEXIS | PRO+ Required for all systems using subscriptions, and clients running macOS® 12 (Monterey) or Windows® 11.
...
USM Versions (USM1) The Unified System Management firmware package is a bundle of firmware for the hardware components in an Avid NEXIS, such as the power supply units, Controllers, and the Baseboard Management Controller (BMC2).
USM upgrades are currently performed remotely by Avid. Contact Avid Global Customer Services for details. Some USM firmware versions are supported only with certain Avid NEXIS versions and models; see the following tables for details.
Avid NEXIS F-Series USM and BMC Versions USM BMC Minimum Avid NEXIS Supported Models Version 5.2_r2020.40.8_RC5_Rel-3096 00.52 2023.3.0 Avid NEXIS F-Series, Avid NEXIS | SDA+, Avid NEXIS | PRO+ 5.2_r2020.40.6_v02 00.45 2022.5.0 Avid NEXIS F-Series, Avid NEXIS | SDA+, (Displays as “BON” in the Avid NEXIS | PRO+ Management Console) Avid NEXIS E-Series (Legacy) USM and BMC Versions (Corrected July 2023) USM BMC Minimum Avid Supported Models NEXIS Version 1.37B 0.01.0045 2022.12.0 Avid NEXIS E-series, Avid NEXIS | PRO 40TB with Controller 10, Avid NEXIS | SDA
> **Note:** Dual Controllers in the same chassis must run the
same USM version.
1USM versions are shown on the Engines page and the Controllers page in the Management Console.
2BMC versions are shown on the Controllers page in the Management Console.
USM BMC Minimum Avid Supported Models NEXIS Version 1.37a 0.01.0041 2019.2.0 Avid NEXIS E-series, Avid NEXIS | PRO 40TB with Controller 10
> **Note:** 1.37 0.01.003c 2019.2.0
Can use USM 1.37 and 1.37a in the same Engine for models that support dual controllers 4.1.16g 2.00.1093c 2019.2.0 Avid NEXIS | PRO 20TB , Avid NEXIS | PRO 40TB with purple fascia Controller 4.1.16d 2.0.0002 1.32 0.01.0034 7.9.1 Legacy Avid NEXIS E-series 1.16 0.01.0013 6.x Legacy Avid NEXIS E-series What’s New in Avid NEXIS 2023.8.2 Avid NEXIS version 2023.8.2 is a patch release for both on-premises and Cloud systems.
...
New Features The 2023.8 release now supports up to 5 million files on systems with an Avid NEXIS | PRO+ running the System Director, and any combination of PRO and PRO+ Engines. See "System Configuration Limits" on page 17 for more information.
...
time, unexpected behavior can occur. This happens if the mounted Workspaces have the same names, even if they are on different Avid NEXIS | Cloud Storage systems.
[SSENG-37493 & 37525] Resolved an issue that caused Media Composer running on macOS clients to
- halt with the error message “VideoEffectConsumer::ChangePixelFormat()” when using Avid NEXIS
client 2023.7.0 or 2023.8.0 and sequences with effects such as TC burn layer or swish pans.
...
Avid NEXIS | EDGE Fixes and Notes
- [SSENG-37504, 37174, 37344] Resolved an issue that prevented customers from seeing all Avid NEXIS
Workspaces when using version 2023.8.x on the system and version 2023.3.0 on clients.
...
Customers with Avid NEXIS | SDA+ and All-Mirror Engines or licenses should not upgrade to version 2023.8.0 or 2023.8.1. See "Known Issues" on page 22 for more information.
Support for 175 Million Files with Avid NEXIS | SDA+ This release includes support for up to 175 million files on a system that includes an Avid NEXIS | SDA+, the Avid NEXIS | FS Advanced license, and any combination of E-Series and F-Series Engines See "System Configuration Limits" on page 17 for more information.
...
Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2023.8.2 2020.x, 2021.x, 2022.x, 2023.3.0, 2023.8.0, 2023.8.1 Do not upgrade any on-premises system to 2023.7.0.
Do not upgrade any system that has or has previously had Avid NEXIS | Cloudspaces to 2023.8.0 or higher.
Avid NEXIS | Cloud 2021.3.1 and newer 2023.3.0 or 2023.8.2 Storage systems To upgrade Avid NEXIS | Cloud Do not upgrade any Avid NEXIS Cloud Storage Storage 2020.7.x and earlier system to 2023.7.0 or 2023.8.0.
...
7.4, kernel version 3.10.0-693.17 Specifically for use with AutoDesk Flame 2021; also see "Hardware and Software Requirements" on page 13.
Ubuntu 22.04 To migrate MediaCentral | Cloud UX systems from CentOS to Ubuntu, see the MediaCentral Cloud UX Documentation.
Windows 11 build 21H2 10 build 22H2 See "Windows 10 Issues" on page 26.
...
On-Premises Limits Item Embedded System Director System Director Appliance Media Packs (per 4, in any combination of Scale-Out and 8 in a High Performance Storage Group system) High Performance 24 total (optionally including up to 8 in a High Performance Storage Group) with the Avid NEXIS | VFS Standard or Avid NEXIS | FS Standard license and any combination of Avid NEXIS Engines 64 total (optionally including up to 8 in a High Performance Storage Group) with the Avid NEXIS | VFS Advanced or Avid NEXIS | FS Advanced license, and any combination of Avid NEXIS Engines Media Packs (per 1 in all 2U chassis (Avid NEXIS | E2, Avid NEXIS | E2 All-Mirror, Avid NEXIS | E2 SSD, Avid Engine) NEXIS | PRO, Avid NEXIS | F2, Avid NEXIS | F2X, Avid NEXIS | PRO+) 1-2 in Avid NEXIS | F2 SSD 1–2 in all 4U chassis (Avid NEXIS | E4, Avid NEXIS | E4 All-Mirror) 4–8 in all 5U chassis (Avid NEXIS | E5, Avid NEXIS | E5 NL, Avid NEXIS | E5 All-Mirror, Avid NEXIS | F5, Avid NEXIS | F5 NL) Storage Groups 4, optionally including one High 32, optionally including one High Performance Storage Group Performance Storage Group Workspaces 1024 (including Workspaces for Teams) 3072 (including Workspaces for Teams) Teams 19 80 Team Quotas Up to 255 Team Quotas per system (Teams have only one quota per Storage Group — which can be increased or decreased — but can have a quota in multiple Storage Groups) Team Admin Users No enforced limit Users (Clients) 5640 (including Users in Teams) User Groups 1028 (including User Groups in Teams) Group Non-Team users can belong to 71 non-Team user groups Memberships per Team users can belong to 71 user groups in the same Team User Connected (Active) 40 with Avid NEXIS E-Series/F-Series 165 with Avid NEXIS | VFS Standard or Avid Clients Engines NEXIS | FS Standard license 30 with Avid NEXIS | PRO or Avid NEXIS | 330 with Avid NEXIS | VFS Advanced or Avid PRO+ NEXIS | FS Advanced license Up to 10 to a High Performance Storage Group (Avid strongly recommends no more than 10) Item Embedded System Director System Director Appliance Files and Folders 8 million in Avid NEXIS E-series/F-Series 175 million in configurations with an Avid configurations NEXIS | SDA+ and the Avid NEXIS | FS Advanced license running Avid NEXIS 5 million in configurations where the version 2023.8.0 or higher System Director service runs on an Avid NEXIS | PRO+ 28.4 million in configurations with an Avid NEXIS | SDA or Avid NEXIS | SDA+ with the 3 million in configurations where the Avid NEXIS | FS Standard license.
...
Item Limit (67 bytes). Longer average file names reduce the file count limit.
...
Avid NEXIS On-Premises Systems Issues Issue Number SSENG-37497: After a customer upgraded their Avid NEXIS and clients to version 2023.7.0 or 2023.8.0, Pro Tools workflows experienced distortions in recorded audio and WAV file corruption.
...
Issue Number (32119): When running System Monitor View, the system logs out after two hours, although this mode is not supposed to time out. This will be fixed in an upcoming release.
...
workstations.
Issue Number SSENG-38076: In Avid NEXIS Client version 2023.8.1 on Windows clients, instead of mounting a Workspace as a specific drive letter in the Client Manager (when you right-click a Workspace and select Assign Mount Point), the Client Manager starts with drive letter Z: and works backwards through the alphabet, ignoring the user-specified letter.
Workaround: Uninstall Client version 2023.8.1, reboot, and install an earlier Cient version (such as 2023.3.0). This issue will be fixed in an upcoming release.
...
Workaround: On the macOS client, click System Preferences > Security & Privacy > Privacy > Full Disk Access avidbenchmarkd.
and check the box for You might need to provide Administrator credentials to unlock this function (Padlock icon).
