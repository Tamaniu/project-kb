...
Revision History Date Version Changes Nov. 22, 2023 2023.8.3 Patch for Windows clients only; see "What’s New in Avid NEXIS 2023.8.3" Oct. 11, 2023 2023.8.1 New issue identified; see "Known Issues" on page 19 Oct. 6, 2023 2023.8.1 Added new section for Avid NEXIS | EDGE fixes. "What’s New in Avid NEXIS Jul. 31, 2023 2023.7.0 Withdrawn due to incorrect read issue; fixed in 2023.8.0.
...
"End of Support for Avid NEXIS | Cloudspaces (Amended August Apr. 25, 2023 2023.3.0 Updates:
Date Version Changes
- Added support for macOS 13 (Ventura) for client systems; see
"Supported Client Operating Systems " on page 13
- Revised the Aggregate Performance and Drive Rebuild numbers for
F2 SSD systems (see "SSD Performance Updated values April 2023" on page 17 and "Drive Rebuilds and System Performance Updated SSD values April 2023" on page 17) Mar. 28, 2023 2023.3.0 See "What's New in Avid NEXIS Version 2023.3.0" on page 10 Contents What's New in Avid NEXIS Version 2023.3.0 10 Updated Security Guidelines 12 Secure Data Deletion 12 Hardware and Software Requirements 12 Supported Upgrade Paths 12 System Director and Client Version Compatibility 13 Supported Client Operating Systems 13 CentOS Version Compatibility with Avid NEXIS Client and VFS Gateway Versions 14 Supported Browsers in an Avid NEXIS On-Premises Environment 14 Compatibility with Other Avid Products 14 Third Party Editor Compatibility 14 Supported Upgrade Paths 15 System Performance (On-Premises) 15 Known Issues 19 Special Notes 24 Legal Notices 25 Accessing the Online Documentation The Avid NEXIS documentation is accessible in PDF format from the Avid NEXIS Knowledge Base.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Windows Clients 2023.8.3 Recommended for all Avid NEXIS Windows Clients running only Crowdstrike. See "What’s New in Avid NEXIS 2023.8.3" on page 6.
Product Version Guidance Server and Clients 2023.8.x Version 2023.8.2 is recommended for all Avid NEXIS systems (on- premises and Cloud).
...
See "What’s New in Avid NEXIS 2023.8.2" on the next page.
See also "What’s New in Avid NEXIS 2023.8.1" on the next page and "What’s New in Avid NEXIS 2023.8.0 (On-Premises Only)" on page 8.
...
See "What's New in Avid NEXIS Version 2023.3.0" on page 10 for more information.
...
Update July 2022: Required for all systems that include Avid NEXIS F-Series engines or Avid NEXIS | PRO+ Required for all systems using subscriptions, and clients running macOS® 12 (Monterey) or Windows® 11.
...
New Features The 2023.8 release now supports up to 5 million files on systems with an Avid NEXIS | PRO+ running the System Director, and any combination of PRO and PRO+ Engines. See "System Configuration Limits" on page 1 for more information.
...
large numbers of files Customers with Avid NEXIS | SDA+ and All-Mirror Engines or licenses should not upgrade to version 2023.8.0 or 2023.8.1. See "Known Issues" on page 19 for more information.
Support for 175 Million Files with Avid NEXIS | SDA+ This release includes support for up to 175 million files on a system that includes an Avid NEXIS | SDA+, the Avid NEXIS | FS Advanced license, and any combination of E-Series and F-Series Engines See "System Configuration Limits" on page 1 for more information.
...
- What's New in Avid NEXIS Version 2023.3.0
...
Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2023.8.2 2020.x, 2021.x, 2022.x, 2023.x Do not upgrade any on-premises system to 2023.7.0.
...
Windows 11 build 22H2 11 build 21H2 See "Windows 10 Issues" on page 22.
...
You can upgrade any Avid NEXIS system according to the upgrade path described next. For instructions on how to upgrade an Engine or System Director Appliance, see the Avid NEXIS Setup and Maintenance Guide, or the Avid NEXIS Administration Guide.
All Avid NEXIS systems can upgrade to the following versions.
Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2023.8.2 2020.x, 2021.x, 2022.x, 2023.x Do not upgrade any on-premises system to 2023.7.0.
