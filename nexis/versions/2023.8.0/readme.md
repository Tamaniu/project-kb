...
Revision History Date Release Changes Update Sept 7, 2023: see Avid NEXIS Client Issues on page 21.
07/31/2023 2023.7.0 Withdrawn due to incorrect read issue; fixed in 2023.8.0.
...
"End of Support for Avid NEXIS | Cloudspaces (Amended August 04/25/2023 2023.3.0 Updates:
- Added support for macOS 13 (Ventura) for client systems; see
"Supported Client Operating Systems " on page 12
- Revised the Aggregate Performance and Drive Rebuild numbers for
F2 SSD systems (see "SSD Performance Updated values April 2023" on page 18 and "Drive Rebuilds and System Performance Updated SSD values April 2023" on page 19) Date Release Changes Contents Updated Security Guidelines 11 Secure Data Deletion 11 Hardware and Software Requirements 11 Supported Upgrade Paths 11 System Director and Client Version Compatibility 12 Supported Client Operating Systems 12 CentOS Version Compatibility with Avid NEXIS Client and VFS Gateway Versions 13 Supported Browsers in an Avid NEXIS On-Premises Environment 13 Compatibility with Other Avid Products 14 Third Party Editor Compatibility 14 System Configuration Limits 15 System Performance (On-Premises) 17 Known Issues 19 Special Notes 25 Qualified and Approved Avid NEXIS Switches 25 Flow Control Required in Avid Production Networks 26 ATTO® ThunderLink™ 10 GbE and 40 GbE Adapters 26 VMware ESXi™ 26 VMware on Windows 26 Legal Notices 27 Accessing the Online Documentation The Avid NEXIS documentation is accessible in PDF format from the Avid NEXIS Knowledge Base.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Server and 2023.8.0 Recommended for all on-premises Avid NEXIS systems and clients. (For Clients Avid NEXIS | Cloud Storage systems, continue to use version 2023.3.0.) Support for 175 million files; support for Windows 10 Build 22H2; see for full details.
Server and 2023.7.0 Withdrawn. All Avid NEXIS | PRO+ and Avid NEXIS F-Series customers Clients running version 2023.7.0 must upgrade to 2023.8.0 as soon as possible.
Introduced modular licenses for F-Series Engines and the PRO+; see "What’s New in Avid NEXIS 2023.7.0" on page 8 for more information.
Server and 2023.3.0 Introduced Avid NEXIS | F2 SSD.
Clients See "What's New in Avid NEXIS Version 2023.3.0" on page 9 for more information.
...
Server and 2022.9.0 l Licensing improvements and updates Clients
- Renamed Avid NEXIS | VFS Gateway, and added support for
CentOS 7.9; fixed a Samba vulnerability
- Increased user group membership limit
- Addressed security issues
Servers and 2022.5.0 Update July 2022: Required for all systems that include Avid NEXIS F- Clients Series engines or Avid NEXIS | PRO+ Required for all systems using subscriptions, and clients running macOS® 12 (Monterey) or Windows® 11.
Avid NEXIS version 2021.8 and older are no longer recommended. Avid NEXIS version 2019 and older are no longer supported.
...
USM Versions (USM1) The Unified System Management firmware package is a bundle of firmware for the hardware components in an Avid NEXIS, such as the power supply units, Controllers, and the Baseboard Management (BMC2).
Controller USM upgrades are currently performed remotely by Avid. Contact Avid Global Customer Services for details. Some USM firmware versions are supported only with certain Avid NEXIS versions and models; see the following tables for details.
Avid NEXIS F-Series USM and BMC Versions USM BMC Minimum Avid NEXIS Supported Models Version 5.2_r2020.40.8_RC5_Rel-3096 00.52 2023.3.0 Avid NEXIS F-Series, Avid NEXIS | SDA+, (Displays as “BON” in the Avid NEXIS | PRO+ Management Console) 5.2_r2020.40.6_v02 00.45 2022.5.0 Avid NEXIS F-Series, Avid NEXIS | SDA+, (Displays as “BON” in the Avid NEXIS | PRO+ Management Console) Avid NEXIS E-Series (Legacy) USM and BMC Versions (Corrected July 2023) USM BMC Minimum Avid Supported Models NEXIS Version 1.37B 0.01.0045 2022.12.0 Avid NEXIS E-series, Avid NEXIS | PRO 40TB with Controller 10, Avid NEXIS | SDA
...
Can use USM 1.37 and 1.37a in the same Engine for models that support dual controllers 4.1.16g 2.00.1093c 2019.2.0 Avid NEXIS | PRO 20TB , Avid NEXIS | PRO 40TB with purple fascia Controller 4.1.16d 2.0.0002 1.32 0.01.0034 7.9.1 Legacy Avid NEXIS E-series 1.16 0.01.0013 6.x Legacy Avid NEXIS E-series 1USM versions are shown on the Engines page and the Controllers page in the Management Console.
2BMC versions are shown on the Controllers page in the Management Console.
What’s New in Avid NEXIS 2023.8.0 (On-Premises Only) Avid NEXIS version 2023.8.0 is a major release for on-premises systems only that contains the following features and fixes:
...
Support for 175 Million Files This release allows you to store up to 175 million files on an Avid NEXIS system that includes an Avid NEXIS | SDA+ and any combination of E-Series and F-Series Engines.
The actual file limit can vary depending on the length of the file and directory names. For example you can have 175 million files if the file and directory names are less than or up to 64 bytes (ASCII characters). Files with special characters (non-ASCII, such as letters with diacritical marks) will reduce the file count limit.
...
VFS Gateway Fixes
- [SSENG-34729] Improved the behavior of LDAP log files. A new log file is started weekly or whenever
the current log file reaches 20MB. The current log file contents are copied to a file named ldap.log.<datestamp>.
...
Server Fixes
- [SSENG-37057] After upgrading an Avid NEXIS system to version 2023.7.0, F-series and PRO+
Engines reported an invalid USM firmware version. This issue did not affect Avid NEXIS E-series or PRO 40TB Engines and did not affect system operation.
...
Name is now consistent with the same field in the Agent. When running in Engine mode, the display now includes the Storage System Name and the Engine name.
What’s New in Avid NEXIS 2023.7.0 Avid has removed version 2023.7.0 from the Downloads site and recommends upgrading to version 2023.8.0 as soon as possible, especially for installations using Avid Media Composer. All of the features introduced in 2023.7.0 are also in 2023.8.0.
...
- indicating whether the Media Pack is in an Engine with a Modular License. Before the license is
activated, the column displays N/A. After the modular license is activated, the column displays either Flexible Protection or All Mirror Protection, depending on the license details.
...
- only Engine in a new or existing system. You can enable or disable the System Director service on the
Engine as needed through the Agent. There is no limit to how often an Engine can change roles in this way.
...
End of Support for Avid NEXIS | Cloudspaces (Amended August 2023) The Avid NEXIS Cloudspaces feature is no longer supported in version 2023.7.0 and higher. It will continue Management Console to appear in the until further notice.
...
Cloud Fixes
- SSENG-35033: Offline license activation now works correctly.
Client Fixes
...
What's New in Avid NEXIS Version 2023.3.0 This is a major release that introduces the following new features and platforms:
...
stricter standard for energy efficiency. The label on the new power supply units includes the suffix - ECO to distinguish them from the older models with the suffix -HE. The part numbers on the ECO models have changed as well.
...
- Avid NEXIS versions 2022.5.x through 2022.12.0, changing the system time by more than 20 minutes
would invalidate the license. This could happen if the time was entered in 12-hour format and later changed to 24-hour format. This fix allows the time to change by a larger amount, including to correct the time to 24-hour format.
...
Storage systems can be upgraded to version 2023.3.0 to take advantage of this new support. Before the upgrade, the [[[Undefined variable Title.MgtCons]]] contains a button to deactivate the current license. After the upgrade, that button is no longer displayed. After you upgrade to this version, your system will need a new license if you want to change the capacity or the renewal date. (See also "Known Issues" on page 19.)
...
3.48TB drives, yielding a total Engine capacity of 38.4TB (one Media Pack) or 76.8TB (two Media
- Packs)
- 15.3TB drives, yielding a total Engine capacity of 153.6TB (one Media Pack) or 307TB (two Media
Packs) When running the embedded System Director Service, up to four Avid NEXIS | F2 SSD Engines can be combined in one shared-storage system (up to 4 Media Packs total).
...
Total Engine Capacity License Capacity Number of Media Packs 1 38.4TB 39TB 2 76.8TB 78TB 1 153.6TB 154TB 2 307.2TB 308TB The Avid NEXIS | F2 SSD can also be added to an existing shared-storage system where another Engine runs the embedded System Director, or one that uses a [[[Undefined variable Title.SDA-long]]].
...
- systems to report Delayed Write Failures and No Connection errors when copying files to a
Workspace.
...
Cloud Fixes in This Release SSENG-33556 Improved the delete performance for Avid NEXIS | Cloud Storage systems.
...
Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2023.8.0 2020.x, 2021.x, 2022.x, 2023.3.0, 2023.7.0 Do not upgrade any on-premises system to 2023.7.0.
Do not upgrade any system that has or has previously had Avid NEXIS | Cloudspaces to 2023.8.0.
Avid NEXIS | Cloud 2021.3.1 and newer 2023.3.0 Storage systems To upgrade Avid NEXIS | Cloud Do not upgrade any Avid NEXIS Cloud Storage Storage 2020.7.x and earlier system to 2023.7.0 or 2023.8.0.
...
Operating Supported Versions Notes System macOS 13.x (Ventura) with latest updates See and the Knowledge Base page: Avid Products and macOS Catalina Support 12.x (Monterey) with latest updates
> **Note:** macOS clients are not supported
11.x (Big Sur) with latest updates with Avid NEXIS | Cloud Storage systems.
CentOS 7.9, 7.8, 7.7, 7.6 General Avid NEXIS Client use Operating Supported Versions Notes System 7.5, kernel 4.4.174-1.el7 Supported only on MediaCentral | Cloud UX systems running CentOS 7.5 7.5, kernel 3.10.0-862.el7.x86_64 See the Avid Audio and Video Compatibility Charts on the Avid Knowledge Base page for more information on compatibility.
7.4, kernel version 3.10.0-693.17 Specifically for use with AutoDesk Flame 2021; also see "Hardware and Software Requirements" on page 11.
Ubuntu 22.04 Supported only for MediaCentral | Cloud UX version 2023.3 or later.
To migrate MediaCentral | Cloud UX systems running CentOS to Ubuntu, see the MediaCentral Cloud UX Documentation.
Windows 11 build 21H2 10 build 22H2 See "Windows 10 Issues" on page 24.
Windows Server 2022 with latest Service Pack 2019 with latest Service Pack CentOS Version Compatibility with Avid NEXIS Client and VFS Gateway Versions The following versions of CentOS support the specified versions of the Avid NEXIS Client software and the Avid NEXIS | VFS Gateway (formerly Avid NEXIS | Linux File Gateway) software.
...
- Maxon Cinema 4D®
As of Final Cut Pro X10.4, you can store library files on Avid NEXIS instead of on local drives.
...
On-Premises Limits Item Embedded System Director System Director Appliance Media Packs (per 4, in any combination of 8 in a High Performance Storage Group system) Scale-Out and High 24 total (optionally including up to 8 in a High Performance Performance Storage Group) with the Avid NEXIS | VFS Standard or Avid NEXIS | FS Standard license and any combination of Avid NEXIS Engines 64 total (optionally including up to 8 in a High Performance Storage Group) with the Avid NEXIS | VFS Advanced or Avid NEXIS | FS Advanced license, and any combination of Avid NEXIS Engines Media Packs (per 1 in all 2U chassis (Avid NEXIS | E2, Avid NEXIS | E2 All-Mirror, Avid NEXIS | E2 SSD, Avid NEXIS | Engine) PRO, Avid NEXIS | F2, Avid NEXIS | F2X, Avid NEXIS | PRO+) 1-2 in Avid NEXIS | F2 SSD 1–2 in all 4U chassis (Avid NEXIS | E4, Avid NEXIS | E4 All-Mirror) 4–8 in all 5U chassis (Avid NEXIS | E5, Avid NEXIS | E5 NL, Avid NEXIS | E5 All-Mirror, Avid NEXIS | F5, Avid NEXIS | F5 NL) Storage Groups 4, optionally including one 32, optionally including one High Performance Storage High Performance Storage Group Group Workspaces 1024 (including Workspaces 3072 (including Workspaces for Teams) for Teams) Teams 19 80 Team Quotas Up to 255 Team Quotas per system (Teams have only one quota per Storage Group — which can be increased or decreased — but can have a quota in multiple Storage Groups) Team Admin No enforced limit Users Users (Clients) 5640 (including Users in Teams) User Groups 1028 (including User Groups in Teams) Group Non-Team users can belong to 71 non-Team user groups Memberships per Team users can belong to 71 user groups in the same Team User Connected 40 (Avid NEXIS E-Series/F- 165 with Avid NEXIS | VFS Standard or Avid NEXIS | FS (Active) Clients Series Engines) Standard license 30 (Avid NEXIS | PRO or Avid 330 with Avid NEXIS | VFS Advanced or Avid NEXIS | FS NEXIS | PRO+) Advanced license Item Embedded System Director System Director Appliance Up to 10 to a High Performance Storage Group (Avid strongly recommends no more than 10) Files and Folders 8 million (Avid NEXIS E- 175 million in configurations with an Avid NEXIS | SDA+ series/F-Series configurations, running Avid NEXIS version 2023.8.0 or higher running supported Avid NEXIS
> **Note:** versions up to 2023.7.0) (Actual limit depends on file name length. Limit
assumes 67 ASCII characters (67 bytes). Longer 3 million (Avid NEXIS | average file names reduce the file count limit.) PRO/Avid NEXIS | PRO+ configurations) Files per folder Avid recommends no more than 5000 files per folder in Workspaces.
...
Team Quotas Up to 255 Team Quotas per system (Teams have only one quota per Storage Group — which can be increased or decreased — but can have a quota in multiple Storage Groups) Team Admin Users No enforced limit Users (Clients) 5640 (including Users in Teams) User Groups 1028 (including User Groups in Teams) Group Memberships per User Non-Team users can belong to 15 non-Team user groups Team users can belong to 15 user groups in the same Team Connected (Active) Clients 330 Files and Folders 28.4 million
> **Note:** (Actual limit depends on file name length. Limit assumes 67 ASCII
characters (67 bytes). Longer average file names reduce the file count limit.) Files per folder Avid recommends no more than 10,000 files per folder, particularly for Workspaces used by Avid MediaCentral | Production Management (formerly Avid Item Limit Interplay | Production).
Pathnames Total bytes = 255 (Workspace name + path + filename).
Unicode characters can be multi-byte.
...
Performance Type Rebuild Rate (Media Pack at 100% capacity) Drive Size Estimated Rebuild Time Scale-Out 48MB/sec 4TB 24 hours 0.17TB/hr or ~6hr/TB 6TB 36 hours 10TB 60 hours 14TB 84 hours 16TB 96 hours High 70MB/sec 4TB 16 hours 6TB 24 hours 0.25TB/hour, or ~4 hr/TB 10TB 40 hours 14TB 56 hours SSD 700MB/sec 3.48TB ~1.3 hours 2.52TB/hour, or ~24 min/TB 15.3TB ~6 hours
...
Avid NEXIS On-Premises Systems Issues Issue Number: SSENG-37249 — Occasionally when creating a new file system on Avid NEXIS | SDA+ a spurious error message is displayed that the System Director is not running. The file system creation process will complete normally. Wait for confirmation in the main Management Console.
Issue Number: SSENG-37053 — After updating an Avid NEXIS system to version 2023.7.0, some of the Controllers reported a Firmware Mismatch issue, and indicated that the USM version on the Controller was invalid. The mismatch is caused by extended firmware version checking in 2023.7.0 and does not necessarily indicate a problem.
...
Issue Number: SSENG-35018 — If a system drive fails in an Avid NEXIS 5U system (Avid NEXIS | F5, Avid NEXIS | F5 NL, Avid NEXIS | E5, or Avid NEXIS | E5 NL) the system rebuilds the data on one of the system drives from the other one. The system might report that the rebuild is complete but the status message stops updating at 88% complete.
Workaround:You can either ignore this message or reboot the Engine.
...
workstations.
Issue Number: Added Sept 7, 2023 SSENG-37344 — After the Avid NEXIS system was updated to version 2023.8.0, clients running version 2023.3.0 could not see all the available Workspaces.
Workaround: In production environments that need to keep the clients on version 2023.3.0, install (or reinstall) Avid NEXIS version 2023.8.0 on the server with the following toggle:
--toggles=dir_search_streaming:0 This turns off some of the Avid NEXIS | EDGE workflow improvements, which are not required for on- premises work, and provides full compatibility between 2023.3.0 clients and 2023.8.0 server.
The Installation page in the Management Console should look like the following:
...
Issue Number: If you mount a workspace by mapping a network drive in Windows, when you unmount the workspace and then mount a different workspace in Client Manager manually using the same drive letter, Windows Explorer displays the previous workspace name instead of the new workspace name.
...
Issue Number: SSENG-23026 — UPDATED Aug 2021 Avid Benchmark Utility does not work automatically on Avid NEXIS clients running macOS 10.15 (Catalina) and newer. On these clients, you must explicitly allow permission for an application (including Avid Benchmark Utility) to have Full Disk Access.
...
Ubuntu Issues
> **Note:** Avid NEXIS supports Ubuntu version 22.04 only for MediaCentral | Cloud UX version 2023.3 or later.
Issue Number: SSEPIC-748 — If your MediaCentral Cloud UX server is attached to your network through a 10Gb or greater connection, you might see reduced total bandwidth when using v2023.3 or higher of the Avid NEXIS Client.
...
Issue Number: SSENG-28533 — On Windows 10 build 20H2 clients, Windows Defender might prevent Avid Pro Tools from starting a session on an Avid NEXIS Workspace.
...
Switches, Adapters, and Drivers Qualified and Approved Avid NEXIS Switches For a list of the current qualified and approved switches for use in the Avid NEXIS Production Network (APN), see the Avid NEXIS Network and Switch Guide on the Avid NEXIS Documentation KB page.
> **Note:** The FS SFP28 modules supplied by Avid are specifically branded for Nvidia/Mellanox devices. Use them
only in Nvidia/Mellanox based devices, for example in Avid NEXIS F-Series and PRO+ Engines where applicable. Their operation in devices other than Nvidia/Mellanox has not been tested.
