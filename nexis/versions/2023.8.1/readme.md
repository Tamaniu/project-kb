...
Revision History Date Release Changes 10/11/2023 2023.8.1 New issue identified; see "Known Issues" on page 22 10/06/2023 2023.8.1 Added new section for Avid NEXIS | EDGE fixes. "What’s New in Avid NEXIS 07/31/2023 2023.7.0 Withdrawn due to incorrect read issue; fixed in 2023.8.0.
...
Avid NEXIS System (Server) and Client Releases Product Version Guidance Servers and 2023.8.1 Recommended for all Avid NEXIS systems (on-premises and Cloud).
Clients See "What’s New in Avid NEXIS 2023.8.1" on page 7.
Server and 2023.8.0 Recommended for all on-premises Avid NEXIS systems and clients. (For Avid Clients NEXIS | Cloud Storage systems, continue to use version 2023.3.0.) Support for 175 million files with SDA+, 5 million files with PRO+; support for Windows 10 Build 22H2; see "What’s New in Avid NEXIS 2023.8.0 (On- Premises Only)" on page 8 for full details.
Server and 2023.7.0 Withdrawn. All Avid NEXIS | PRO+ and Avid NEXIS F-Series customers Clients running version 2023.7.0 must upgrade to 2023.8.1 as soon as possible.
...
Clients See "What's New in Avid NEXIS Version 2023.3.0" on page 11 for more information.
...
- Renamed Avid NEXIS | VFS Gateway, and added support for CentOS
7.9; fixed a Samba vulnerability
- Increased user group membership limit
- Addressed security issues
Servers and 2022.5.0 Update July 2022: Required for all systems that include Avid NEXIS F-Series Clients engines or Avid NEXIS | PRO+ Required for all systems using subscriptions, and clients running macOS® 12 (Monterey) or Windows® 11.
Product Version Guidance Avid NEXIS version 2021.8 and older are no longer recommended. Avid NEXIS version 2019 and older are no longer supported.
...
USM BMC Minimum Avid Supported Models NEXIS Version 1.16 0.01.0013 6.x Legacy Avid NEXIS E-series What’s New in Avid NEXIS 2023.8.1 Avid NEXIS version 2023.8.1 is a patch release for both on-premises and Cloud systems.
...
Current Avid NEXIS Version Can Upgrade Directly To On-premises systems 6.x, 7.x, 2018.x, 2019.x, 2023.8.1 2020.x, 2021.x, 2022.x, 2023.3.0, 2023.8.0 Do not upgrade any on-premises system to 2023.7.0.
Do not upgrade any system that has or has previously had Avid NEXIS | Cloudspaces to 2023.8.0 or higher.
Avid NEXIS | Cloud 2021.3.1 and newer 2023.3.0 or 2023.8.1 Storage systems To upgrade Avid NEXIS | Cloud Do not upgrade any Avid NEXIS Cloud Storage Storage 2020.7.x and earlier system to 2023.7.0 or 2023.8.0.
...
Avid NEXIS On-Premises Systems Issues Issue Number SSENG-38012: [October 2023] Avid has identified a problem that prevents upgrades on the following configurations: Avid NEXIS | SDA+ with All-Mirror Engines (either E-Series All-Mirror Engines, or F- Series with the All-Mirror license).
This issue does not affect configurations with Avid NEXIS | SDA, or with an Engine that runs the embedded System Director, or Flexible Mirror Engines. This issue also does not affect Avid NEXIS | PRO or Avid NEXIS | PRO+ configurations.
Current Status:Avid is working on a patch release for these specific configurations to address this issue. The patch can also safely be applied to all other Avid NEXIS configurations or skipped.
...
Issue Number SSENG-36923 : The VFS Gateway tool cannot process Active Directory Groups or Users with wildcard characters in the Organizational Unit string (for example, OU=*Groups). Groups with special characters or wildcards can return unexpected results or no results at all.
