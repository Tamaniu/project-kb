...
Bug Number: MCCET-5799. Performing Audio Mixdown with multiple mixes targeting an Avid NEXIS workspace could cause Media Composer to become unresponsive.
Bug Number: MCCET-6281. MXF OP1a exports could lose stereo separation, resulting in identical audio on both channels.
...
Fixed in Media Composer v2025.12 Bug Number: MCCET-4972. The Active Format Description (AFD) metadata entry was missing from exported media files.
...
Fixed in Media Composer v2025.12 Bug Number: MCCET-5908. Editing FrameFlex effects on group clips resulted in incorrect images being displayed in the Effects Editor.
...
Fixed in Media Composer v2025.12 Bug Number: MCCET-5979. When 32-bit WAV files were imported or transcoded into a 50p project, the audio start timecode failed to register correctly.
...
Fixed in Media Composer v2025.12 Bug Number: MCCET-6031. Using 'Create script from clip' on an auto-synced clip resulted in script text being generated multiple times.
...
Fixed in Media Composer v2025.12 Bug Number: MCCET-5893. (macOS) Drag-and-drop from Interplay Access to Media Composer bins was unsuccessful.
...
Fixed in Media Composer v2025.12 Bug Number: MCCET-6167. (MediaCentral | Production Management) Frequent freezing and sluggish timeline operations occurred when using XAVC-I media during workflows with large sequences.
