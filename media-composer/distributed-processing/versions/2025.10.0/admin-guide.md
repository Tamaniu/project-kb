...
Avid Media Composer | Distributed Processing Administration Guide Version 2025.10 Using This Guide Using This Guide This document provides instructions for installing, configuring, and using Avid Distributed Processing. Avid recommends that you read all of the information in this document before installing, or using the corresponding software release.
...
Revision History Date Revised Changes Made November 14, 2025 Initial Release Using This Guide Symbols and Conventions Avid documentation uses the following symbols and conventions:
